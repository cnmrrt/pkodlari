...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const filter = ref("");
    const { data: konyaData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "konya-data",
      () => $fetch("https://pkodlari.com/data/konya.json")
    )), __temp = await __temp, __restore(), __temp);
    const districtSlug = computed(() => route.params.district);
    const districtData = computed(() => {
      if (!konyaData.value) return null;
      const filtered = konyaData.value.filter(
    ...
    const pageDesc = computed(
      () => districtData.value ? `Konya ilinin ${titleCase(
            ...
            children: JSON.stringify({
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 2,
                  name: "Konya",
                  item: "https://pkodlari.com/konya"
                },
                {
                  "@type": "ListItem",
                  position: 3,
                  name: titleCase(districtData.value.name),
                  item: `https://pkodlari.com/konya/${districtSlug.value}`
                }
              ]
            })
          };
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (isValid.value) {
        ...
        _push(ssrRenderComponent(_component_NuxtLink, { to: "/konya" }, {
        ...
        _push(`<div><h1>${ssrInterpolate(unref(titleCase)(districtData.value.name))} Posta Kodlar\u0131 </h1><p> Konya </p></div></div><div class="neighborhood-search-container">`);
        ...
        ssrRenderList(neighs.value, (nItem) => {
          _push(ssrRenderComponent(_component_NuxtLink, {
            key: nItem.slug,
            to: `/konya/${districtSlug.value}/${nItem.slug}`
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`Konya sayfas\u0131na d\xF6n`);
            } else {
              return [
                createTextVNode("Konya sayfas\u0131na d\xF6n")
              ];
            }
          }),
          _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/konya/[district]/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-DcKr0EM1.mjs.map
