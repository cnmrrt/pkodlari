...
const { data: districtData } = await useAsyncData("zeytinburnu-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/istanbul/zeytinburnu.json")
);

const cityName = "İstanbul";
const citySlug = "istanbul";
const districtName = "Zeytinburnu";
const districtSlug = "zeytinburnu";
