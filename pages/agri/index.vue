...
const pageDesc = computed(() => agriData.value ? `${titleCase(agriData.value.name)} iline bağlı ilçe ve mahallelerin posta kodlarını görmek için tıklayın!` : 'Posta Kodu Rehberi');
useHead({
title: pageTitle,
...
<div>
<h1 class="text-3xl font-bold text-slate-900 tracking-tight">{{ titleCase(agriData.name) }} Posta Kodları</h1>
