...
<p class="text-slate-500 text-sm font-medium uppercase tracking-wider">Elazığ</p>
</div>
</div>
...
:key="nItem.slug"
:to="`/elazig/${districtSlug}/${nItem.slug}`"
...
<p>İlçe bulunamadı.</p>
<NuxtLink to="/elazig" class="text-slate-900 underline mt-4 inline-block">Elazığ sayfasına dön</NuxtLink>
</div>
</template>
