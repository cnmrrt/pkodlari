...
<p class="text-slate-500 text-sm font-medium uppercase tracking-wider">Bartın</p>
</div>
</div>
...
:key="nItem.slug"
:to="`/bartin/${districtSlug}/${nItem.slug}`"
...
<p>İlçe bulunamadı.</p>
<NuxtLink to="/bartin" class="text-slate-900 underline mt-4 inline-block">Bartın sayfasına dön</NuxtLink>
</div>
</template>
