...
$fetch<any[]>('https://words-from-life-5cb26-default-rtdb.firebaseio.com/posta_kodlari_duzenlenmis/amasya.json')
)                                                                                                                ;
...
<NuxtLink to="/amasya" class="hover:text-slate-900 transition-colors">AMASYA</NuxtLink>
<ChevronRight class="w-3 h-3" />
<NuxtLink :to="`/amasya/${districtSlug}`" class="hover:text-slate-900 transition-colors">{{
...
<p class="text-slate-600">{{ neighData.postaKodu }} posta kodu Amasya {{
...
<p class="text-slate-600">{{ titleCase(neighData.mahalle) }}, Amasya ilinin {{ titleCase(neighData.ilce) }} ilçesine bağlıdır. Posta kodu yapısı incelendiğinde                                                                                              ;</p>
<ol>
