...
const { data: districtData } = await useAsyncData("sincan-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/ankara/sincan.json")
);

const cityName = "Ankara";
const citySlug = "ankara";
const districtName = "Sincan";
const districtSlug = "sincan";
