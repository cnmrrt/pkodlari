...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: istanbulBesiktasData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "istanbul-besiktas-data",
      () => $fetch("https://pkodlari.com/data/istanbul/besiktas.json")
    ...
    const otherNeighborhoods = computed(() => {
      ...
      return istanbulBesiktasData.value.filter((item) => slugify(item.ilce || districtName) === districtSlug).map((item) => ({
        name: item.mahalle,
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/istanbul/besiktas/[neighborhood].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_neighborhood_-Br5nc7N5.mjs.map
