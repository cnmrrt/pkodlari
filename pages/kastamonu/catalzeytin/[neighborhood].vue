...
const { data: kastamonuCatalzeytinData } = await useAsyncData("kastamonu-catalzeytin-data", () =>
  $fetch<any[]>(useRequestURL().origin + "/data/kastamonu/catalzeytin.json")
);

const cityName = "Kastamonu";
const citySlug = "kastamonu";
const districtName = "Çatalzeytin";
...
const otherNeighborhoods = computed(() => {
  ...
  return kastamonuCatalzeytinData.value
