...
const pageDesc = "Siirt iline bağlı ilçe ve mahallelerin posta kodlarını görmek için tıklayın!";
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div><h1 class="text-3xl font-bold text-slate-900 tracking-tight">Siirt Posta Kodları</h1><p class="text-slate-500 text-sm font-medium uppercase tracking-wider">${ssrInterpolate(unref(districts).length)} İLÇE</p></div></div><div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4"><!--[-->`);
