...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const filter = ref("");
    const { data: konyaData } = ([__temp, __restore] = withAsyncContext(async () => useAsyncData("konya-specific-data", async () => {
      const response = await $fetch("/api/data/konya");
      const cityObj = {
        name: "KONYA",
        districts: {}
      };
    ...
    const districtItem = computed(() => {
      var _a;
      return (_a = konyaData.value) == null ? void 0 : _a.districts[distSlug.value];
    });
            ...
            children: JSON.stringify({
              ...
              "itemListElement": [
                ...
                },
                {
                  ...
                  "item": `https://postakodu.com/konya/${distSlug.value}`
                }
              ]
            })
          };
...
//# sourceMappingURL=index-DRyL1cnR.mjs.map
