...
<p class="text-slate-500 text-sm font-medium uppercase tracking-wider">Eskişehir</p>
</div>
</div>
...
:key="nItem.slug"
:to="`/eskisehir/${districtSlug}/${nItem.slug}`"
...
<p>İlçe bulunamadı.</p>
<NuxtLink to="/eskisehir" class="text-slate-900 underline mt-4 inline-block">Eskişehir sayfasına dön</NuxtLink>
</div>
</template>
