import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, inject, getCurrentInstance, computed, toValue, onServerPrefetch, defineComponent, shallowRef, h, resolveComponent, ref, nextTick, unref, toRef, useSSRContext, Suspense, Fragment, createElementBlock, provide, cloneVNode, createApp, mergeProps, withCtx, createVNode, createTextVNode, shallowReactive, withAsyncContext, onErrorCaptured, resolveDynamicComponent, reactive, effectScope, defineAsyncComponent, getCurrentScope, isReadonly, isRef, isShallow, isReactive, toRaw } from 'file:///Users/mac/Desktop/pkodlari/node_modules/vue/index.mjs';
import { $fetch as $fetch$1 } from 'file:///Users/mac/Desktop/pkodlari/node_modules/ofetch/dist/node.mjs';
import { b as baseURL } from '../_/renderer.mjs';
import { createHooks } from 'file:///Users/mac/Desktop/pkodlari/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file:///Users/mac/Desktop/pkodlari/node_modules/unctx/dist/index.mjs';
import { createError as createError$1, sanitizeStatusCode, appendHeader } from 'file:///Users/mac/Desktop/pkodlari/node_modules/h3/dist/index.mjs';
import { RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/mac/Desktop/pkodlari/node_modules/vue-router/vue-router.node.mjs';
import { defu } from 'file:///Users/mac/Desktop/pkodlari/node_modules/defu/dist/defu.mjs';
import { parseQuery, hasProtocol, joinURL, withQuery, isScriptProtocol, withTrailingSlash, withoutTrailingSlash } from 'file:///Users/mac/Desktop/pkodlari/node_modules/ufo/dist/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderSuspense, ssrRenderVNode } from 'file:///Users/mac/Desktop/pkodlari/node_modules/vue/server-renderer/index.mjs';
import { MapPin } from 'file:///Users/mac/Desktop/pkodlari/node_modules/lucide-vue-next/dist/cjs/lucide-vue-next.js';
import { debounce } from 'file:///Users/mac/Desktop/pkodlari/node_modules/perfect-debounce/dist/index.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CWN_iN66.mjs')
  },
  {
    name: "mus",
    path: "/mus",
    component: () => import('./index-B5BVo3a5.mjs')
  },
  {
    name: "van",
    path: "/van",
    component: () => import('./index-CnYWVAQo.mjs')
  },
  {
    name: "agri",
    path: "/agri",
    component: () => import('./index-Bokujw9D.mjs')
  },
  {
    name: "bolu",
    path: "/bolu",
    component: () => import('./index-SHUD44yo.mjs')
  },
  {
    name: "kars",
    path: "/kars",
    component: () => import('./index-DV-NMn0N.mjs')
  },
  {
    name: "ordu",
    path: "/ordu",
    component: () => import('./index-BlK1JMTU.mjs')
  },
  {
    name: "rize",
    path: "/rize",
    component: () => import('./index-nk1DvA9T.mjs')
  },
  {
    name: "usak",
    path: "/usak",
    component: () => import('./index-B57TgZKV.mjs')
  },
  {
    name: "adana",
    path: "/adana",
    component: () => import('./index-6tQURIpc.mjs')
  },
  {
    name: "aydin",
    path: "/aydin",
    component: () => import('./index-DUAhDX2O.mjs')
  },
  {
    name: "bursa",
    path: "/bursa",
    component: () => import('./index-C6953LMH.mjs')
  },
  {
    name: "corum",
    path: "/corum",
    component: () => import('./index-DX9DxPuH.mjs')
  },
  {
    name: "duzce",
    path: "/duzce",
    component: () => import('./index-Bmd_RJ9m.mjs')
  },
  {
    name: "igdir",
    path: "/igdir",
    component: () => import('./index-BN3B5E0d.mjs')
  },
  {
    name: "izmir",
    path: "/izmir",
    component: () => import('./index-h7VsUhDi.mjs')
  },
  {
    name: "kilis",
    path: "/kilis",
    component: () => import('./index-DcjI8PiG.mjs')
  },
  {
    name: "mugla",
    path: "/mugla",
    component: () => import('./index-DL2YA1d0.mjs')
  },
  {
    name: "nigde",
    path: "/nigde",
    component: () => import('./index-C4HrVtEv.mjs')
  },
  {
    name: "siirt",
    path: "/siirt",
    component: () => import('./index-bLLphsks.mjs')
  },
  {
    name: "sivas",
    path: "/sivas",
    component: () => import('./index-m0h2H-ma.mjs')
  },
  {
    name: "tokat",
    path: "/tokat",
    component: () => import('./index-DDhvBTfF.mjs')
  },
  {
    name: "city",
    path: "/:city()",
    component: () => import('./index-Dw2ZaRVa.mjs')
  },
  {
    name: "amasya",
    path: "/amasya",
    component: () => import('./index-DhG109R-.mjs')
  },
  {
    name: "ankara",
    path: "/ankara",
    component: () => import('./index-BeBI7Ooz.mjs')
  },
  {
    name: "artvin",
    path: "/artvin",
    component: () => import('./index-BgrL-s1D.mjs')
  },
  {
    name: "bartin",
    path: "/bartin",
    component: () => import('./index-Dj3oZM1c.mjs')
  },
  {
    name: "batman",
    path: "/batman",
    component: () => import('./index-Dy9yawv-.mjs')
  },
  {
    name: "bingol",
    path: "/bingol",
    component: () => import('./index-BWmubuA-.mjs')
  },
  {
    name: "bitlis",
    path: "/bitlis",
    component: () => import('./index-BdobIki3.mjs')
  },
  {
    name: "burdur",
    path: "/burdur",
    component: () => import('./index-OHZdkR0F.mjs')
  },
  {
    name: "edirne",
    path: "/edirne",
    component: () => import('./index-DTWg0qz5.mjs')
  },
  {
    name: "elazig",
    path: "/elazig",
    component: () => import('./index-CqIPDBgG.mjs')
  },
  {
    name: "manisa",
    path: "/manisa",
    component: () => import('./index-D0jEuehW.mjs')
  },
  {
    name: "mardin",
    path: "/mardin",
    component: () => import('./index-DfqR3Nmq.mjs')
  },
  {
    name: "mersin",
    path: "/mersin",
    component: () => import('./index-Dns_F5PE.mjs')
  },
  {
    name: "samsun",
    path: "/samsun",
    component: () => import('./index-CHhGPuLX.mjs')
  },
  {
    name: "sirnak",
    path: "/sirnak",
    component: () => import('./index-cAm4daHv.mjs')
  },
  {
    name: "yalova",
    path: "/yalova",
    component: () => import('./index-BTqsomG9.mjs')
  },
  {
    name: "yozgat",
    path: "/yozgat",
    component: () => import('./index-D7Y0dvwd.mjs')
  },
  {
    name: "aksaray",
    path: "/aksaray",
    component: () => import('./index-BuL66G2h.mjs')
  },
  {
    name: "bilecik",
    path: "/bilecik",
    component: () => import('./index-Dz7I6tg9.mjs')
  },
  {
    name: "cankiri",
    path: "/cankiri",
    component: () => import('./index-D2gzaYtX.mjs')
  },
  {
    name: "denizli",
    path: "/denizli",
    component: () => import('./index-qa2kAXtg.mjs')
  },
  {
    name: "erzurum",
    path: "/erzurum",
    component: () => import('./index-CwIVb0zK.mjs')
  },
  {
    name: "giresun",
    path: "/giresun",
    component: () => import('./index-B1mOU3gj.mjs')
  },
  {
    name: "isparta",
    path: "/isparta",
    component: () => import('./index-G-BBIXg6.mjs')
  },
  {
    name: "karabuk",
    path: "/karabuk",
    component: () => import('./index-Cu7jTMpP.mjs')
  },
  {
    name: "karaman",
    path: "/karaman",
    component: () => import('./index-1cy_Vik4.mjs')
  },
  {
    name: "kayseri",
    path: "/kayseri",
    component: () => import('./index-BDnSfvb8.mjs')
  },
  {
    name: "kocaeli",
    path: "/kocaeli",
    component: () => import('./index-B6pfSoj3.mjs')
  },
  {
    name: "kutahya",
    path: "/kutahya",
    component: () => import('./index-Ck3d8vhF.mjs')
  },
  {
    name: "malatya",
    path: "/malatya",
    component: () => import('./index-COwh5-ML.mjs')
  },
  {
    name: "sakarya",
    path: "/sakarya",
    component: () => import('./index-2KqtmBd-.mjs')
  },
  {
    name: "trabzon",
    path: "/trabzon",
    component: () => import('./index-DFuf8pkK.mjs')
  },
  {
    name: "adiyaman",
    path: "/adiyaman",
    component: () => import('./index-BbNovKej.mjs')
  },
  {
    name: "erzincan",
    path: "/erzincan",
    component: () => import('./index-VXvA7ru0.mjs')
  },
  {
    name: "istanbul",
    path: "/istanbul",
    component: () => import('./index-zHckIYMe.mjs')
  },
  {
    name: "kirsehir",
    path: "/kirsehir",
    component: () => import('./index-DapxjGvl.mjs')
  },
  {
    name: "nevsehir",
    path: "/nevsehir",
    component: () => import('./index-BjjeuzAt.mjs')
  },
  {
    name: "osmaniye",
    path: "/osmaniye",
    component: () => import('./index-MRSPb-IJ.mjs')
  },
  {
    name: "tekirdag",
    path: "/tekirdag",
    component: () => import('./index-D3D38LxL.mjs')
  },
  {
    name: "balikesir",
    path: "/balikesir",
    component: () => import('./index-Bm6P2Eg3.mjs')
  },
  {
    name: "canakkale",
    path: "/canakkale",
    component: () => import('./index-CP5tRDA3.mjs')
  },
  {
    name: "eskisehir",
    path: "/eskisehir",
    component: () => import('./index-n3I9L7ke.mjs')
  },
  {
    name: "gaziantep",
    path: "/gaziantep",
    component: () => import('./index-fsUxcyJ2.mjs')
  },
  {
    name: "gumushane",
    path: "/gumushane",
    component: () => import('./index-DxzqKESk.mjs')
  },
  {
    name: "kastamonu",
    path: "/kastamonu",
    component: () => import('./index-B9iiwAUF.mjs')
  },
  {
    name: "kirikkale",
    path: "/kirikkale",
    component: () => import('./index-iK4BY3ZP.mjs')
  },
  {
    name: "zonguldak",
    path: "/zonguldak",
    component: () => import('./index-p8OIodNP.mjs')
  },
  {
    name: "diyarbakir",
    path: "/diyarbakir",
    component: () => import('./index-CDDzu_jo.mjs')
  },
  {
    name: "kirklareli",
    path: "/kirklareli",
    component: () => import('./index-90IFesAu.mjs')
  },
  {
    name: "afyonkarahisar",
    path: "/afyonkarahisar",
    component: () => import('./index-Co69O-lt.mjs')
  },
  {
    name: "mus-district",
    path: "/mus/:district()",
    component: () => import('./index-DMmJqwax.mjs')
  },
  {
    name: "van-district",
    path: "/van/:district()",
    component: () => import('./index-BUMUxk8z.mjs')
  },
  {
    name: "agri-district",
    path: "/agri/:district()",
    component: () => import('./index-CdswrdYo.mjs')
  },
  {
    name: "bolu-district",
    path: "/bolu/:district()",
    component: () => import('./index-BdQV21HT.mjs')
  },
  {
    name: "kars-district",
    path: "/kars/:district()",
    component: () => import('./index-DJXRPKyy.mjs')
  },
  {
    name: "ordu-district",
    path: "/ordu/:district()",
    component: () => import('./index-Wv_mZT1I.mjs')
  },
  {
    name: "rize-district",
    path: "/rize/:district()",
    component: () => import('./index-CcEp_-FH.mjs')
  },
  {
    name: "usak-district",
    path: "/usak/:district()",
    component: () => import('./index-CpeMpzk_.mjs')
  },
  {
    name: "adana-district",
    path: "/adana/:district()",
    component: () => import('./index-C87nGOmh.mjs')
  },
  {
    name: "aydin-district",
    path: "/aydin/:district()",
    component: () => import('./index-BWyS55cy.mjs')
  },
  {
    name: "bursa-district",
    path: "/bursa/:district()",
    component: () => import('./index-wtF65S86.mjs')
  },
  {
    name: "corum-district",
    path: "/corum/:district()",
    component: () => import('./index-w40ArPtR.mjs')
  },
  {
    name: "duzce-district",
    path: "/duzce/:district()",
    component: () => import('./index-DTMKPfB0.mjs')
  },
  {
    name: "igdir-district",
    path: "/igdir/:district()",
    component: () => import('./index-9AVqK0iB.mjs')
  },
  {
    name: "izmir-district",
    path: "/izmir/:district()",
    component: () => import('./index-Dnl4x7jc.mjs')
  },
  {
    name: "kilis-district",
    path: "/kilis/:district()",
    component: () => import('./index-B2T2_cQX.mjs')
  },
  {
    name: "mugla-district",
    path: "/mugla/:district()",
    component: () => import('./index-DMs2kFbZ.mjs')
  },
  {
    name: "nigde-district",
    path: "/nigde/:district()",
    component: () => import('./index-F_Mrk_F6.mjs')
  },
  {
    name: "siirt-district",
    path: "/siirt/:district()",
    component: () => import('./index-B3hG0LIk.mjs')
  },
  {
    name: "sivas-district",
    path: "/sivas/:district()",
    component: () => import('./index-DvfFFNvf.mjs')
  },
  {
    name: "tokat-district",
    path: "/tokat/:district()",
    component: () => import('./index-BeCetg-M.mjs')
  },
  {
    name: "city-district",
    path: "/:city()/:district()",
    component: () => import('./index-QTkSBsrJ.mjs')
  },
  {
    name: "amasya-district",
    path: "/amasya/:district()",
    component: () => import('./index-CSLIfkNX.mjs')
  },
  {
    name: "ankara-district",
    path: "/ankara/:district()",
    component: () => import('./index-DcJ9tler.mjs')
  },
  {
    name: "artvin-district",
    path: "/artvin/:district()",
    component: () => import('./index-DTYpYfZB.mjs')
  },
  {
    name: "bartin-district",
    path: "/bartin/:district()",
    component: () => import('./index-BqMOvjAq.mjs')
  },
  {
    name: "batman-district",
    path: "/batman/:district()",
    component: () => import('./index-C_G8zRdJ.mjs')
  },
  {
    name: "bingol-district",
    path: "/bingol/:district()",
    component: () => import('./index-CkJrnzX4.mjs')
  },
  {
    name: "bitlis-district",
    path: "/bitlis/:district()",
    component: () => import('./index-2otMRCG8.mjs')
  },
  {
    name: "burdur-district",
    path: "/burdur/:district()",
    component: () => import('./index-DFQ4tEYL.mjs')
  },
  {
    name: "edirne-district",
    path: "/edirne/:district()",
    component: () => import('./index-DoxDwRUK.mjs')
  },
  {
    name: "elazig-district",
    path: "/elazig/:district()",
    component: () => import('./index-BRqayE2E.mjs')
  },
  {
    name: "manisa-district",
    path: "/manisa/:district()",
    component: () => import('./index-gCd0XhLF.mjs')
  },
  {
    name: "mardin-district",
    path: "/mardin/:district()",
    component: () => import('./index-DU3dWs8S.mjs')
  },
  {
    name: "mersin-district",
    path: "/mersin/:district()",
    component: () => import('./index-BSle2jiF.mjs')
  },
  {
    name: "samsun-district",
    path: "/samsun/:district()",
    component: () => import('./index-CU0BB60Y.mjs')
  },
  {
    name: "sirnak-district",
    path: "/sirnak/:district()",
    component: () => import('./index-CWnKntSb.mjs')
  },
  {
    name: "yalova-district",
    path: "/yalova/:district()",
    component: () => import('./index-DcbtaiTs.mjs')
  },
  {
    name: "yozgat-district",
    path: "/yozgat/:district()",
    component: () => import('./index-BYkET7Er.mjs')
  },
  {
    name: "aksaray-district",
    path: "/aksaray/:district()",
    component: () => import('./index-CpCtKYJ_.mjs')
  },
  {
    name: "bilecik-district",
    path: "/bilecik/:district()",
    component: () => import('./index-CMYQUbUj.mjs')
  },
  {
    name: "cankiri-district",
    path: "/cankiri/:district()",
    component: () => import('./index-DVl5Imif.mjs')
  },
  {
    name: "denizli-district",
    path: "/denizli/:district()",
    component: () => import('./index-D6_wRjBg.mjs')
  },
  {
    name: "erzurum-district",
    path: "/erzurum/:district()",
    component: () => import('./index-DYQMb9K5.mjs')
  },
  {
    name: "giresun-district",
    path: "/giresun/:district()",
    component: () => import('./index-CzvmazhF.mjs')
  },
  {
    name: "isparta-district",
    path: "/isparta/:district()",
    component: () => import('./index-D6kN3j86.mjs')
  },
  {
    name: "karabuk-district",
    path: "/karabuk/:district()",
    component: () => import('./index-DEW_IU-5.mjs')
  },
  {
    name: "karaman-district",
    path: "/karaman/:district()",
    component: () => import('./index-KDgiU2J8.mjs')
  },
  {
    name: "kayseri-district",
    path: "/kayseri/:district()",
    component: () => import('./index-Bqltw4aL.mjs')
  },
  {
    name: "kocaeli-district",
    path: "/kocaeli/:district()",
    component: () => import('./index-DEz8WtNA.mjs')
  },
  {
    name: "kutahya-district",
    path: "/kutahya/:district()",
    component: () => import('./index-eFEL4DDq.mjs')
  },
  {
    name: "malatya-district",
    path: "/malatya/:district()",
    component: () => import('./index-PDIb3zHd.mjs')
  },
  {
    name: "sakarya-district",
    path: "/sakarya/:district()",
    component: () => import('./index-IzlDqVfT.mjs')
  },
  {
    name: "trabzon-district",
    path: "/trabzon/:district()",
    component: () => import('./index-DtJZnvHP.mjs')
  },
  {
    name: "adiyaman-district",
    path: "/adiyaman/:district()",
    component: () => import('./index-D9sveG7s.mjs')
  },
  {
    name: "erzincan-district",
    path: "/erzincan/:district()",
    component: () => import('./index-Mah2V3wQ.mjs')
  },
  {
    name: "istanbul-district",
    path: "/istanbul/:district()",
    component: () => import('./index-BViSR1-q.mjs')
  },
  {
    name: "kirsehir-district",
    path: "/kirsehir/:district()",
    component: () => import('./index-BmjnQCuP.mjs')
  },
  {
    name: "nevsehir-district",
    path: "/nevsehir/:district()",
    component: () => import('./index-Dg6zQrXn.mjs')
  },
  {
    name: "osmaniye-district",
    path: "/osmaniye/:district()",
    component: () => import('./index-BDj-6n2n.mjs')
  },
  {
    name: "tekirdag-district",
    path: "/tekirdag/:district()",
    component: () => import('./index-DifRHOSc.mjs')
  },
  {
    name: "balikesir-district",
    path: "/balikesir/:district()",
    component: () => import('./index-C3QRPmJ1.mjs')
  },
  {
    name: "canakkale-district",
    path: "/canakkale/:district()",
    component: () => import('./index-CZgddpP4.mjs')
  },
  {
    name: "eskisehir-district",
    path: "/eskisehir/:district()",
    component: () => import('./index-CeodWgmM.mjs')
  },
  {
    name: "gaziantep-district",
    path: "/gaziantep/:district()",
    component: () => import('./index-JpnXFObO.mjs')
  },
  {
    name: "gumushane-district",
    path: "/gumushane/:district()",
    component: () => import('./index-Diugp6-T.mjs')
  },
  {
    name: "kastamonu-district",
    path: "/kastamonu/:district()",
    component: () => import('./index-Bb-RjyJb.mjs')
  },
  {
    name: "kirikkale-district",
    path: "/kirikkale/:district()",
    component: () => import('./index-C7BQ2LCh.mjs')
  },
  {
    name: "zonguldak-district",
    path: "/zonguldak/:district()",
    component: () => import('./index-Bfe9x2oQ.mjs')
  },
  {
    name: "diyarbakir-district",
    path: "/diyarbakir/:district()",
    component: () => import('./index-rFopeoVS.mjs')
  },
  {
    name: "kirklareli-district",
    path: "/kirklareli/:district()",
    component: () => import('./index-D6LCptVr.mjs')
  },
  {
    name: "mus-district-neighborhood",
    path: "/mus/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-BGR7mo8W.mjs')
  },
  {
    name: "van-district-neighborhood",
    path: "/van/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-soKlRgbk.mjs')
  },
  {
    name: "agri-district-neighborhood",
    path: "/agri/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-D7t_6RzO.mjs')
  },
  {
    name: "bolu-district-neighborhood",
    path: "/bolu/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-BK9L-nAj.mjs')
  },
  {
    name: "kars-district-neighborhood",
    path: "/kars/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-BoBMQFyk.mjs')
  },
  {
    name: "ordu-district-neighborhood",
    path: "/ordu/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-CUY18yzI.mjs')
  },
  {
    name: "rize-district-neighborhood",
    path: "/rize/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-rJCuSvHL.mjs')
  },
  {
    name: "usak-district-neighborhood",
    path: "/usak/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-Gbmpj8Ga.mjs')
  },
  {
    name: "adana-district-neighborhood",
    path: "/adana/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-BOuQWkCl.mjs')
  },
  {
    name: "afyonkarahisar-district",
    path: "/afyonkarahisar/:district()",
    component: () => import('./index-DrAMJi2h.mjs')
  },
  {
    name: "aydin-district-neighborhood",
    path: "/aydin/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-D_gY4qZZ.mjs')
  },
  {
    name: "bursa-district-neighborhood",
    path: "/bursa/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-BFmADZ2C.mjs')
  },
  {
    name: "corum-district-neighborhood",
    path: "/corum/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-CC-JsQJl.mjs')
  },
  {
    name: "duzce-district-neighborhood",
    path: "/duzce/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-QGCao-Oe.mjs')
  },
  {
    name: "igdir-district-neighborhood",
    path: "/igdir/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-kLT2RKst.mjs')
  },
  {
    name: "izmir-district-neighborhood",
    path: "/izmir/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-8SZ4xod8.mjs')
  },
  {
    name: "kilis-district-neighborhood",
    path: "/kilis/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-tQJNsdgd.mjs')
  },
  {
    name: "mugla-district-neighborhood",
    path: "/mugla/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-B7bjqdKK.mjs')
  },
  {
    name: "nigde-district-neighborhood",
    path: "/nigde/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-LtsKDGqn.mjs')
  },
  {
    name: "siirt-district-neighborhood",
    path: "/siirt/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-BZugNOhY.mjs')
  },
  {
    name: "sivas-district-neighborhood",
    path: "/sivas/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-CbXNCJBu.mjs')
  },
  {
    name: "tokat-district-neighborhood",
    path: "/tokat/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-hobToRjL.mjs')
  },
  {
    name: "city-district-neighborhood",
    path: "/:city()/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-2Y6dCmAv.mjs')
  },
  {
    name: "amasya-district-neighborhood",
    path: "/amasya/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-BcTSgfNo.mjs')
  },
  {
    name: "ankara-district-neighborhood",
    path: "/ankara/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-DKQL7pyo.mjs')
  },
  {
    name: "artvin-district-neighborhood",
    path: "/artvin/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-BbVLtBc4.mjs')
  },
  {
    name: "bartin-district-neighborhood",
    path: "/bartin/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-C0ib9ZoD.mjs')
  },
  {
    name: "batman-district-neighborhood",
    path: "/batman/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-FF78pv5F.mjs')
  },
  {
    name: "bingol-district-neighborhood",
    path: "/bingol/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-DqHcF8bs.mjs')
  },
  {
    name: "bitlis-district-neighborhood",
    path: "/bitlis/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-C2_wc3Dk.mjs')
  },
  {
    name: "burdur-district-neighborhood",
    path: "/burdur/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-Exz-iKWC.mjs')
  },
  {
    name: "edirne-district-neighborhood",
    path: "/edirne/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-q9nDgHAw.mjs')
  },
  {
    name: "elazig-district-neighborhood",
    path: "/elazig/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-C_YKL0B8.mjs')
  },
  {
    name: "manisa-district-neighborhood",
    path: "/manisa/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-BF_SDhJq.mjs')
  },
  {
    name: "mardin-district-neighborhood",
    path: "/mardin/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-k-qi5TFy.mjs')
  },
  {
    name: "mersin-district-neighborhood",
    path: "/mersin/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-GenJTLKi.mjs')
  },
  {
    name: "samsun-district-neighborhood",
    path: "/samsun/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-be13S87x.mjs')
  },
  {
    name: "sirnak-district-neighborhood",
    path: "/sirnak/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-DlQPcLRG.mjs')
  },
  {
    name: "yalova-district-neighborhood",
    path: "/yalova/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-K5YXiKWO.mjs')
  },
  {
    name: "yozgat-district-neighborhood",
    path: "/yozgat/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-Dzlcr3Xt.mjs')
  },
  {
    name: "aksaray-district-neighborhood",
    path: "/aksaray/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-Bzyke24U.mjs')
  },
  {
    name: "bilecik-district-neighborhood",
    path: "/bilecik/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-3y1m0X4t.mjs')
  },
  {
    name: "cankiri-district-neighborhood",
    path: "/cankiri/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-CldnT3Kl.mjs')
  },
  {
    name: "denizli-district-neighborhood",
    path: "/denizli/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-0Csz1bv0.mjs')
  },
  {
    name: "erzurum-district-neighborhood",
    path: "/erzurum/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-tEupQrfO.mjs')
  },
  {
    name: "giresun-district-neighborhood",
    path: "/giresun/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-vB9d4ZWE.mjs')
  },
  {
    name: "isparta-district-neighborhood",
    path: "/isparta/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-YePcU7Qy.mjs')
  },
  {
    name: "karabuk-district-neighborhood",
    path: "/karabuk/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-86xFY9UL.mjs')
  },
  {
    name: "karaman-district-neighborhood",
    path: "/karaman/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-C76amPuU.mjs')
  },
  {
    name: "kayseri-district-neighborhood",
    path: "/kayseri/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-BTLUYNWL.mjs')
  },
  {
    name: "kocaeli-district-neighborhood",
    path: "/kocaeli/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-atGXsGjs.mjs')
  },
  {
    name: "kutahya-district-neighborhood",
    path: "/kutahya/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-DrrLQxcl.mjs')
  },
  {
    name: "malatya-district-neighborhood",
    path: "/malatya/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-BQhJ1_vz.mjs')
  },
  {
    name: "sakarya-district-neighborhood",
    path: "/sakarya/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-BfwQFn85.mjs')
  },
  {
    name: "trabzon-district-neighborhood",
    path: "/trabzon/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-BFJniE0H.mjs')
  },
  {
    name: "adiyaman-district-neighborhood",
    path: "/adiyaman/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-BSOMZI14.mjs')
  },
  {
    name: "erzincan-district-neighborhood",
    path: "/erzincan/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-CF6wmfGq.mjs')
  },
  {
    name: "istanbul-district-neighborhood",
    path: "/istanbul/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-DTmEWVj4.mjs')
  },
  {
    name: "kirsehir-district-neighborhood",
    path: "/kirsehir/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-BSgnUrbR.mjs')
  },
  {
    name: "nevsehir-district-neighborhood",
    path: "/nevsehir/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-GJW-IQB4.mjs')
  },
  {
    name: "osmaniye-district-neighborhood",
    path: "/osmaniye/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-BE5oic0M.mjs')
  },
  {
    name: "tekirdag-district-neighborhood",
    path: "/tekirdag/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-DXdycf9D.mjs')
  },
  {
    name: "balikesir-district-neighborhood",
    path: "/balikesir/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-DivoSjUB.mjs')
  },
  {
    name: "canakkale-district-neighborhood",
    path: "/canakkale/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-Db_6X23y.mjs')
  },
  {
    name: "eskisehir-district-neighborhood",
    path: "/eskisehir/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-BLptBVx0.mjs')
  },
  {
    name: "gaziantep-district-neighborhood",
    path: "/gaziantep/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-BQMDNsnK.mjs')
  },
  {
    name: "gumushane-district-neighborhood",
    path: "/gumushane/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-CzIVrYAw.mjs')
  },
  {
    name: "kastamonu-district-neighborhood",
    path: "/kastamonu/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-r3UJUWQr.mjs')
  },
  {
    name: "kirikkale-district-neighborhood",
    path: "/kirikkale/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-CcL9TymH.mjs')
  },
  {
    name: "zonguldak-district-neighborhood",
    path: "/zonguldak/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-D7x2PTDA.mjs')
  },
  {
    name: "diyarbakir-district-neighborhood",
    path: "/diyarbakir/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-CvYNMLyx.mjs')
  },
  {
    name: "kirklareli-district-neighborhood",
    path: "/kirklareli/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-qvj2od2r.mjs')
  },
  {
    name: "afyonkarahisar-district-neighborhood",
    path: "/afyonkarahisar/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-DkoD7CQ8.mjs')
  }
];
...
export { __nuxt_component_0 as _, useRoute as a, tryUseNuxtApp as b, useRequestEvent as c, entry_default as default, slugify as s, titleCase as t, useAsyncData as u };
