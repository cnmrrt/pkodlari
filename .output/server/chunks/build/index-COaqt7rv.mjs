...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const pageTitle = `Amasya Posta Kodlar\u0131 ${currentYear}`;
    useHead({
      title: pageTitle,
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div><h1>Amasya Posta Kodlar\u0131 ve \u0130l\xE7eleri</h1><p>${ssrInterpolate(unref(districts).length)} \u0130L\xC7E</p></div></div><div class="districts"><!--[-->`);
...
//# sourceMappingURL=index-COaqt7rv.mjs.map
