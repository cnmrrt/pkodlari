...
const { data: districtData } = await useAsyncData("camlidere-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/ankara/camlidere.json")
);

const cityName = "Ankara";
const citySlug = "ankara";
const districtName = "Çamlıdere";
const districtSlug = "camlidere";
