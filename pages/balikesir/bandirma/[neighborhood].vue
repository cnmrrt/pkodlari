...
const { data: balikesirBandirmaData } = await useAsyncData("balikesir-bandirma-data", () =>
  $fetch<any[]>(useRequestURL().origin + "/data/balikesir/bandirma.json")
);
...
const otherNeighborhoods = computed(() => {
  ...
  return balikesirBandirmaData.value
