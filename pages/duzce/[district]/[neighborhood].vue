...
<p>{{ neighData.postaKodu }} posta kodu Düzce {{
...
<p>{{ titleCase(neighData.mahalle) }}, Düzce ilinin {{ titleCase(neighData.ilce) }} ilçesine bağlıdır. Posta kodu yapısı incelendiğinde                                                                                              ;</p>
<ol>
