...
const { data: districtData } = await useAsyncData("altindag-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/ankara/altindag.json")
);

const cityName = "Ankara";
const citySlug = "ankara";
const districtName = "Altındağ";
const districtSlug = "altindag";
