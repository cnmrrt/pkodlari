...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: edirneData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "edirne-data",
      () => $fetch("https://pkodlari.com/data/edirne.json")
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (isValid.value) {
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`Edirne Sayfasına Dön`);
            } else {
              return [
                createTextVNode("Edirne Sayfasına Dön")
              ];
            }
          }),
          _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/edirne/[district]/[neighborhood].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_neighborhood_-DNAhl5Ur.mjs.map
