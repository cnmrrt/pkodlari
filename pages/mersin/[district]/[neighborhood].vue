...
<p>{{ neighData.postaKodu }} posta kodu Mersin {{
...
<p>{{ titleCase(neighData.mahalle) }}, Mersin ilinin {{ titleCase(neighData.ilce) }} ilçesine bağlıdır. Posta kodu yapısı incelendiğinde                                                                                              ;</p>
<ol>
