...
const { data: districtData } = await useAsyncData("gudul-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/ankara/gudul.json")
);

const cityName = "Ankara";
const citySlug = "ankara";
const districtName = "Güdül";
const districtSlug = "gudul";
