...
<p>{{ neighData.postaKodu }} posta kodu Aydın {{
...
<p>{{ titleCase(neighData.mahalle) }}, Aydın ilinin {{ titleCase(neighData.ilce) }} ilçesine bağlıdır. Posta kodu yapısı incelendiğinde                                                                                              ;</p>
<ol>
