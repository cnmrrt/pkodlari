...
<p>{{ neighData.postaKodu }} posta kodu Trabzon {{
...
<p>{{ titleCase(neighData.mahalle) }}, Trabzon ilinin {{ titleCase(neighData.ilce) }} ilçesine bağlıdır. Posta kodu yapısı incelendiğinde                                                                                              ;</p>
<ol>
