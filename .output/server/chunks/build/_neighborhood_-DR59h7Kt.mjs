...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: ispartaData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "isparta-data",
      () => $fetch("https://words-from-life-5cb26-default-rtdb.firebaseio.com/posta_kodlari_duzenlenmis/isparta.json")
...
//# sourceMappingURL=_neighborhood_-DR59h7Kt.mjs.map
