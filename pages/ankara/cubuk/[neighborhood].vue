...
const { data: districtData } = await useAsyncData("cubuk-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/ankara/cubuk.json")
);

const cityName = "Ankara";
const citySlug = "ankara";
const districtName = "Çubuk";
const districtSlug = "cubuk";
