...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: gaziantepSahinbeyData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "gaziantep-sahinbey-data",
      () => $fetch("https://pkodlari.com/data/gaziantep/sahinbey.json")
    ...
    const otherNeighborhoods = computed(() => {
      ...
      return gaziantepSahinbeyData.value.filter((item) => slugify(item.ilce || districtName) === districtSlug).map((item) => ({
        name: item.mahalle,
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/gaziantep/sahinbey/[neighborhood].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_neighborhood_-Bng2qZ5i.mjs.map
