...
<p>{{ neighData.postaKodu }} posta kodu Tokat {{
...
<p>{{ titleCase(neighData.mahalle) }}, Tokat ilinin {{ titleCase(neighData.ilce) }} ilçesine bağlıdır. Posta kodu yapısı incelendiğinde                                                                                              ;</p>
<ol>
