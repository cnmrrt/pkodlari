...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    useHead({
      title: computed(() => bartinData.value ? `${titleCase(bartinData.value.name)} Posta Kodlar\u0131` : "\u015Eehir Bulunamad\u0131"),
      meta: [
        {
          name: "description",
          content: computed(() => bartinData.value ? `${titleCase(bartinData.value.name)} iline ba\u011Fl\u0131 il\xE7e ve mahallelerin posta kodlar\u0131n\u0131 g\xF6rmek i\xE7in t\u0131klay\u0131n!` : "")
        }
      ],
      script: [
        {
...
//# sourceMappingURL=index-BotoB_Iy.mjs.map
