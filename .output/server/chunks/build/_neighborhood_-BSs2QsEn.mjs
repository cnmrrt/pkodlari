...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: artvinData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "artvin-data",
      () => $fetch("https://words-from-life-5cb26-default-rtdb.firebaseio.com/posta_kodlari_duzenlenmis/artvin.json")
...
//# sourceMappingURL=_neighborhood_-BSs2QsEn.mjs.map
