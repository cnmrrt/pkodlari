...
const { data: districtData } = await useAsyncData("beypazari-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/ankara/beypazari.json")
);

const cityName = "Ankara";
const citySlug = "ankara";
const districtName = "Beypazarı";
const districtSlug = "beypazari";
