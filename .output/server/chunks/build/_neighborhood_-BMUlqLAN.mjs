...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: musData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "mus-data",
      () => $fetch("https://words-from-life-5cb26-default-rtdb.firebaseio.com/posta_kodlari_duzenlenmis/mus.json")
...
//# sourceMappingURL=_neighborhood_-BMUlqLAN.mjs.map
