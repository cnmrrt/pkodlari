...
const { data: districtData } = await useAsyncData("pursaklar-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/ankara/pursaklar.json")
);

const cityName = "Ankara";
const citySlug = "ankara";
const districtName = "Pursaklar";
const districtSlug = "pursaklar";
