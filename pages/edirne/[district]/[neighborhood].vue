...
<p class="main-info-subtitle">{{ titleCase(neighData.ilce) }}, Edirne</p>
</div>
...
<p>{{ neighData.postaKodu }} posta kodu Edirne {{ titleCase(neighData.ilce) }} {{ titleCase(neighData.mahalle) }}'ne aittir.`</p>
</div>

<div class="page-text">
<h2>{{ titleCase(neighData.ilce) }} {{ titleCase(neighData.mahalle) }} Posta Kodu Rehberi</h2>
<p>Edirne {{ titleCase(neighData.ilce) }} {{ titleCase(neighData.mahalle) }}'ne ait güncel posta kodu bilgileri aşağıda yer almaktadır. Adres formlarında, kargo gönderilerinde ve resmi işlemlerde hata payını sıfıra indirmek için bu kodu kullanabilirsiniz.</p>
<br>
...
<p>{{ titleCase(neighData.mahalle) }}, Edirne ilinin {{ titleCase(neighData.ilce) }} ilçesine bağlıdır. Posta kodu yapısı incelendiğinde ;</p>
