...
const { data: districtData } = await useAsyncData("avcilar-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/istanbul/avcilar.json")
);

const cityName = "İstanbul";
const citySlug = "istanbul";
const districtName = "Avcılar";
const districtSlug = "avcilar";
