...
const { data: giresunBulancakData } = await useAsyncData("giresun-bulancak-data", () =>
  $fetch<any[]>(useRequestURL().origin + "/data/giresun/bulancak.json")
);
...
const otherNeighborhoods = computed(() => {
  ...
  return giresunBulancakData.value
