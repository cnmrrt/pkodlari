...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: kastamonuTosyaData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "kastamonu-tosya-data",
      () => $fetch(useRequestURL().origin + "/data/kastamonu/tosya.json")
    ...
    const otherNeighborhoods = computed(() => {
      ...
      return kastamonuTosyaData.value.filter((item) => slugify(item.ilce || districtName) === districtSlug).map((item) => ({
        name: item.mahalle,
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/kastamonu/tosya/[neighborhood].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_neighborhood_-DXRTyCEo.mjs.map
