...
const { data: balikesirGonenData } = await useAsyncData("balikesir-gonen-data", () =>
  $fetch<any[]>("https://pkodlari.com/data/tr/balikesir/gonen.json")
);

const cityName = "Balıkesir";
const citySlug = "balikesir";
const districtName = "Gönen";
...
const otherNeighborhoods = computed(() => {
  ...
  return balikesirGonenData.value
