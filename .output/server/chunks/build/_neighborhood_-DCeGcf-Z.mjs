...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: canakkaleData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "canakkale-data",
      () => $fetch("https://words-from-life-5cb26-default-rtdb.firebaseio.com/posta_kodlari_duzenlenmis/canakkale.json")
...
//# sourceMappingURL=_neighborhood_-DCeGcf-Z.mjs.map
