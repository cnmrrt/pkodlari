...
const pageTitle = `Kırıkkale Posta Kodları ve İlçeleri ${currentYear}`;
const pageDesc =
  "Kırıkkale iline bağlı ilçe ve mahallelerin posta kodlarını görmek için tıklayın!";
