...
<p>{{ neighData.postaKodu }} posta kodu Kayseri {{
...
<p>{{ titleCase(neighData.mahalle) }}, Kayseri ilinin {{ titleCase(neighData.ilce) }} ilçesine bağlıdır. Posta kodu yapısı incelendiğinde                                                                                              ;</p>
<ol>
