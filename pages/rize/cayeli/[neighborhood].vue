...
const { data: RizeCayeliData } = await useAsyncData("rize-cayeli-data", () =>
  $fetch<any[]>("https://pkodlari.com/data/rize/cayeli.json")
);

const cityName = "Rize";
const citySlug = "rize";
const districtName = "ÇAYELİ";
