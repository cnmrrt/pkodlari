...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: duzceData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "duzce-data",
      () => $fetch("https://words-from-life-5cb26-default-rtdb.firebaseio.com/posta_kodlari_duzenlenmis/duzce.json")
...
//# sourceMappingURL=_neighborhood_-Cp0LabQE.mjs.map
