...
<p>{{ neighData.postaKodu }} posta kodu Bartın {{
...
<p>{{ titleCase(neighData.mahalle) }}, Bartın ilinin {{ titleCase(neighData.ilce) }} ilçesine bağlıdır. Posta kodu yapısı incelendiğinde                                                                                              ;</p>
<ol>
