...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: kastamonuData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "kastamonu-data",
      () => $fetch("https://words-from-life-5cb26-default-rtdb.firebaseio.com/posta_kodlari_duzenlenmis/kastamonu.json")
...
//# sourceMappingURL=_neighborhood_-Coc8pJjq.mjs.map
