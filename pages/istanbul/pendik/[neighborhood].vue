...
const { data: districtData } = await useAsyncData("pendik-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/istanbul/pendik.json")
);

const cityName = "İstanbul";
const citySlug = "istanbul";
const districtName = "Pendik";
const districtSlug = "pendik";
