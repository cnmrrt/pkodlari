...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const districtData = computed(() => {
      ...
      const filtered = giresunData.value.filter(
    ...
    const pageTitle = computed(
      () => districtData.value ? `Giresun ${titleCase(districtData.value.name)} Posta Kodlar\u0131` : "\u0130l\xE7e Bulunamad\u0131"
    );
    const pageDesc = computed(
      () => districtData.value ? `Giresun ilinin ${titleCase(
        districtData.value.name
      )} il\xE7esine ba\u011Fl\u0131 mahallelerin posta kodlar\u0131n\u0131 g\xF6rmek i\xE7in t\u0131klay\u0131n!` : "Posta Kodu Rehberi"
    );
    useHead({
      title: pageTitle,
            ...
            children: JSON.stringify({
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 2,
                  name: "Giresun",
                  item: "https://pkodlari.com/giresun"
                },
                {
                  "@type": "ListItem",
                  position: 3,
                  name: titleCase(districtData.value.name),
                  item: `https://pkodlari.com/giresun/${districtSlug.value}`
                }
              ]
            })
          };
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (isValid.value) {
        ...
        _push(ssrRenderComponent(_component_NuxtLink, { to: "/giresun" }, {
        ...
        _push(`<div><h1>${ssrInterpolate(unref(titleCase)(districtData.value.name))} Posta Kodlar\u0131 </h1><p> Giresun </p></div></div><div class="neighborhood-search-container">`);
        ...
        ssrRenderList(neighs.value, (nItem) => {
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div class="mahalle-name"${_scopeId}><h4${_scopeId}>${ssrInterpolate(unref(titleCase)(nItem.name))}</h4><p class="text-[10px] text-slate-400 font-bold uppercase tracking-widest mt-0.5"${_scopeId}> MAHALLE </p></div><div class="mahalle-zip-code"${_scopeId}><span${_scopeId}>${ssrInterpolate(nItem.zipCode)}</span>`);
...
//# sourceMappingURL=index-Df6aegP2.mjs.map
