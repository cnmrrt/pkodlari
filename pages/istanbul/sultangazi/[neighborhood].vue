...
const { data: districtData } = await useAsyncData("sultangazi-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/istanbul/sultangazi.json")
);

const cityName = "İstanbul";
const citySlug = "istanbul";
const districtName = "Sultangazi";
const districtSlug = "sultangazi";
