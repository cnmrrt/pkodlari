...
const pageTitle = computed(() =>
  districtData.value
    ? `${titleCase(districtData.value.name)} Posta Kodları`
    : "İlçe Bulunamadı"
);
const pageDesc = computed(() =>
  districtData.value
    ? `Bayburt ilinin ${titleCase(
...
<template>
  <div v-if="isValid" class="animate-in fade-in duration-500 max-w-4xl mx-auto">
    ...
    <div class="neighborhoods-links-container">
      <NuxtLink
        ...
        :key="nItem.slug"
        :to="`/bayburt/${districtSlug}/${nItem.slug}`"
  ...
  <div v-else class="py-32 text-center text-slate-400">
    <p>İlçe bulunamadı.</p>
    <NuxtLink to="/bayburt" class="text-slate-900 underline mt-4 inline-block"
