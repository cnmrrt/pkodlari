...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: gaziantepData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "gaziantep-data",
      () => $fetch("https://words-from-life-5cb26-default-rtdb.firebaseio.com/posta_kodlari_duzenlenmis/gaziantep.json")
    ...
    const pageDesc = computed(() => neighData.value ? `Gaziantep ilinin ${titleCase(neighData.value.ilce)} il\xE7esine ba\u011Fl\u0131 ${titleCase(neighData.value.mahalle)}'nin posta kodunu g\xF6rmek i\xE7in t\u0131klay\u0131n!` : "Posta Kodu Rehberi");
    useHead({
      title: pageTitle,
...
//# sourceMappingURL=_neighborhood_-C43cs6mY.mjs.map
