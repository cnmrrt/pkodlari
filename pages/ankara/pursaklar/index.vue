...
const { data: rawNeighborhoods } = await useAsyncData("pursaklar-data", () =>
...
<template>
  <div v-if="isValid" class="animate-in fade-in duration-500 max-w-4xl mx-auto">
    ...
    <p style="margin-top: 25px;">Pursaklar, Ankara'ya bağlı bir ilçedir. 6 Mart 2008'de ilçe olmuştur.</p>
  </div>
