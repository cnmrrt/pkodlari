  ...
  async setup(__props) {
    ...
    useHead({
      ...
      meta: [
        {
          name: "description",
          content: computed(() => adiyamanData.value ? `${titleCase(adiyamanData.value.name)} iline ba\u011Fl\u0131 il\xE7e ve mahallelerin posta kodlar\u0131n\u0131 g\xF6rmek i\xE7in t\u0131klay\u0131n!` : "")
        }
      ],
      script: [
        {
...
//# sourceMappingURL=index-Gs7QxP8S.mjs.map
