...
<p class="text-slate-500 text-sm font-medium uppercase tracking-wider">Giresun</p>
</div>
</div>
...
:key="nItem.slug"
:to="`/giresun/${districtSlug}/${nItem.slug}`"
...
<p>İlçe bulunamadı.</p>
<NuxtLink to="/giresun" class="text-slate-900 underline mt-4 inline-block">Giresun sayfasına dön</NuxtLink>
</div>
</template>
