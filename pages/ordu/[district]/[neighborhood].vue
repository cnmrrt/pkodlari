...
<p>{{ neighData.postaKodu }} posta kodu Ordu {{
...
<p>{{ titleCase(neighData.mahalle) }}, Ordu ilinin {{ titleCase(neighData.ilce) }} ilçesine bağlıdır. Posta kodu yapısı incelendiğinde                                                                                              ;</p>
<ol>
