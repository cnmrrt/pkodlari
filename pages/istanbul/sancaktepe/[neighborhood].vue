...
const { data: districtData } = await useAsyncData("sancaktepe-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/istanbul/sancaktepe.json")
);

const cityName = "İstanbul";
const citySlug = "istanbul";
const districtName = "Sancaktepe";
const districtSlug = "sancaktepe";
