...
<p class="text-slate-500 text-sm font-medium uppercase tracking-wider">Mersin</p>
</div>
</div>
...
:key="nItem.slug"
:to="`/mersin/${districtSlug}/${nItem.slug}`"
...
<p>İlçe bulunamadı.</p>
<NuxtLink to="/mersin" class="text-slate-900 underline mt-4 inline-block">Mersin sayfasına dön</NuxtLink>
</div>
</template>
