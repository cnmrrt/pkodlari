...
<p>{{ neighData.postaKodu }} posta kodu Yozgat {{
...
<p>{{ titleCase(neighData.mahalle) }}, Yozgat ilinin {{ titleCase(neighData.ilce) }} ilçesine bağlıdır. Posta kodu yapısı incelendiğinde                                                                                              ;</p>
<ol>
