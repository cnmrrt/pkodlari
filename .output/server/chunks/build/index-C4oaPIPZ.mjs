...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const pageTitle = computed(() => istanbulData.value ? `${titleCase(istanbulData.value.name)} Posta Kodlar\u0131` : "\u015Eehir Bulunamad\u0131");
    const pageDesc = computed(() => istanbulData.value ? `${titleCase(istanbulData.value.name)} iline ba\u011Fl\u0131 il\xE7e ve mahallelerin posta kodlar\u0131n\u0131 g\xF6rmek i\xE7in t\u0131klay\u0131n!` : "Posta Kodu Rehberi");
    useHead({
      title: pageTitle,
    ...
    const districts = computed(() => {
      ...
      return Object.entries(istanbulData.value.districts).sort(([, a], [, b]) => a.name.localeCompare(b.name, "tr"));
    });
    const isValid = computed(() => !!istanbulData.value);
...
//# sourceMappingURL=index-C4oaPIPZ.mjs.map
