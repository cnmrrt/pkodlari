...
const { data: districtData } = await useAsyncData("arnavutkoy-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/istanbul/arnavutkoy.json")
);

const cityName = "İstanbul";
const citySlug = "istanbul";
const districtName = "Arnavutköy";
const districtSlug = "arnavutkoy";
