...
const { data: districtData } = await useAsyncData("bahcelievler-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/istanbul/bahcelievler.json")
);

const cityName = "İstanbul";
const citySlug = "istanbul";
const districtName = "Bahçelievler";
const districtSlug = "bahcelievler";
