...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: districtData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "yenimahalle-details",
      () => $fetch("https://pkodlari.com/data/ankara/yenimahalle.json")
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/ankara/yenimahalle/[neighborhood].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_neighborhood_-D6-FIfIq.mjs.map
