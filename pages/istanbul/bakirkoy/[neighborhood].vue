...
const { data: districtData } = await useAsyncData("bakirkoy-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/istanbul/bakirkoy.json")
);

const cityName = "İstanbul";
const citySlug = "istanbul";
const districtName = "Bakırköy";
const districtSlug = "bakirkoy";
