  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (isValid.value) {
        ...
        _push(ssrRenderComponent(_component_NuxtLink, { to: "/kirsehir" }, {
        ...
        _push(`<div><h1>${ssrInterpolate(unref(titleCase)(districtData.value.name))} Posta Kodlar\u0131</h1><p>K\u0131r\u015Fehir</p></div></div><div class="neighborhood-search-container">`);
...
//# sourceMappingURL=index-B-aJq3f9.mjs.map
