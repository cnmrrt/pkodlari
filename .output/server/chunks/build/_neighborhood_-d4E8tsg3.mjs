...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: nevsehirData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "nevsehir-data",
      () => $fetch("https://pkodlari.com/data/nevsehir.json")
    ...
    const pageDesc = computed(() => neighData.value ? `Nev\u015Fehir ilinin ${titleCase(neighData.value.ilce)} il\xE7esine ba\u011Fl\u0131 ${titleCase(neighData.value.mahalle)}'nin posta kodunu g\xF6rmek i\xE7in t\u0131klay\u0131n!` : "Posta Kodu Rehberi");
    useHead({
      title: pageTitle,
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (isValid.value) {
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`Nev\u015Fehir Sayfas\u0131na D\xF6n`);
            } else {
              return [
                createTextVNode("Nev\u015Fehir Sayfas\u0131na D\xF6n")
              ];
            }
          }),
          _: 1
...
//# sourceMappingURL=_neighborhood_-d4E8tsg3.mjs.map
