...
$fetch<any[]>('https://words-from-life-5cb26-default-rtdb.firebaseio.com/posta_kodlari_duzenlenmis/sakarya.json')
)                                                                                                               ;
...
return sakaryaData.value.find(item =>
...
text: `Sakarya, ${titleCase(neighData.value.ilce)}, ${titleCase(neighData.value.mahalle)} mahallesinin posta kodu: ${neighData.value.postaKodu}`,
...
<NuxtLink to="/sakarya" class="hover:text-slate-900 transition-colors">SAKARYA</NuxtLink>
<ChevronRight class="w-3 h-3" />
<NuxtLink :to="`/sakarya/${districtSlug}`" class="hover:text-slate-900 transition-colors">{{
...
<p class="text-slate-600">{{ neighData.postaKodu }} posta kodu Sakarya {{
...
<p class="text-slate-600">Sakarya {{
...
<p class="text-slate-600">{{ titleCase(neighData.mahalle) }}, Sakarya ilinin {{ titleCase(neighData.ilce) }} ilçesine bağlıdır. Posta kodu yapısı incelendiğinde                                                                                              ;</p>
<ol>
...
<NuxtLink to="/sakarya" class="mt-6 inline-block text-red-700 underline">Sakarya Sayfasına Dön</NuxtLink>
</div>
</div>
</template>
