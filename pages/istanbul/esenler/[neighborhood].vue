...
const { data: districtData } = await useAsyncData("esenler-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/istanbul/esenler.json")
);

const cityName = "İstanbul";
const citySlug = "istanbul";
const districtName = "Esenler";
const districtSlug = "esenler";
