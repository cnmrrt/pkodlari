...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: vanData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "van-data",
      () => $fetch("https://words-from-life-5cb26-default-rtdb.firebaseio.com/posta_kodlari_duzenlenmis/van.json")
...
//# sourceMappingURL=_neighborhood_-Cc4SJHkc.mjs.map
