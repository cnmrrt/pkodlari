...
const pageDesc = "Ardahan iline ba\u011Fl\u0131 il\xE7e ve mahallelerin posta kodlar\u0131n\u0131 g\xF6rmek i\xE7in t\u0131klay\u0131n!";
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const districts = computed(() => {
      ...
      const districtMap = {};
      ardahanData.value.forEach((item) => {
    ...
    const pageTitle = `Ardahan Posta Kodlar\u0131 ve \u0130l\xE7eleri ${currentYear}`;
    useHead({
      title: pageTitle,
      ...
      script: [
        {
          ...
          children: JSON.stringify({
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 2, "name": "Ardahan", "item": "https://pkodlari.com/ardahan" }
            ]
          })
        }
      ]
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div><h1>Ardahan Posta Kodlar\u0131</h1><p>${ssrInterpolate(unref(districts).length)} \u0130L\xC7E</p></div></div><div class="districts"><!--[-->`);
...
//# sourceMappingURL=index-B5uyhLjS.mjs.map
