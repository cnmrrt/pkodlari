...
const { data: districtData } = await useAsyncData("eyup-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/istanbul/eyup.json")
);

const cityName = "İstanbul";
const citySlug = "istanbul";
const districtName = "Eyüp";
const districtSlug = "eyup";
