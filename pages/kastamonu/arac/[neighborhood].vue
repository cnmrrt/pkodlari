...
const { data: kastamonuAracData } = await useAsyncData("kastamonu-arac-data", () =>
  $fetch<any[]>(useRequestURL().origin + "/data/kastamonu/arac.json")
);

const cityName = "Kastamonu";
const citySlug = "kastamonu";
const districtName = "Araç";
...
const otherNeighborhoods = computed(() => {
  ...
  return kastamonuAracData.value
