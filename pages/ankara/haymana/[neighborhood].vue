...
const { data: districtData } = await useAsyncData("haymana-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/ankara/haymana.json")
);

const cityName = "Ankara";
const citySlug = "ankara";
const districtName = "Haymana";
const districtSlug = "haymana";
