...
const pageDesc = computed(() => konyaData.value ? `${titleCase(konyaData.value.name)} iline bağlı ilçe ve mahallelerin posta kodlarını görmek için tıklayın!` : 'Posta Kodu Rehberi');
useHead({
title: pageTitle,
...
<div>
<h1 class="text-3xl font-bold text-slate-900 tracking-tight">{{ titleCase(konyaData.name) }} Posta Kodları</h1>
