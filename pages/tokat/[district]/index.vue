...
<NuxtLink to="/tokat" class="text-slate-400 hover:text-slate-900 transition-colors"><ArrowLeft class="w-5 h-5" /></NuxtLink>
<div>
...
:key="nItem.slug"
:to="`/tokat/${districtSlug}/${nItem.slug}`"
...
<p>İlçe bulunamadı.</p>
<NuxtLink to="/tokat" class="text-slate-900 underline mt-4 inline-block">Tokat sayfasına dön</NuxtLink>
</div>
</template>
