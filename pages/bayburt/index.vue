...
const pageTitle = `Bayburt Posta Kodları ve İlçeleri ${currentYear}`;
const pageDesc =
  "Bayburt iline bağlı ilçe ve mahallelerin posta kodlarını görmek için tıklayın!";
