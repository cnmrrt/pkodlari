...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    useHead({
      title: computed(() => afyonData.value ? `${titleCase(afyonData.value.name)} Posta Kodlar\u0131` : "\u015Eehir Bulunamad\u0131"),
      meta: [
        {
          name: "description",
          content: computed(() => afyonData.value ? `${titleCase(afyonData.value.name)} iline ba\u011Fl\u0131 il\xE7e ve mahallelerin posta kodlar\u0131n\u0131 g\xF6rmek i\xE7in t\u0131klay\u0131n!` : "")
        }
      ],
      script: [
        {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (isValid.value) {
        ...
        _push(`<div><h1 class="text-3xl font-bold text-slate-900 tracking-tight">${ssrInterpolate(("titleCase" in _ctx ? _ctx.titleCase : unref(titleCase))(unref(afyonData).name))} Posta Kodlar\u0131</h1><p class="text-slate-500 text-sm font-medium uppercase tracking-wider">${ssrInterpolate(districts.value.length)} \u0130L\xC7E</p></div></div><div class="grid grid-cols-1 sm:grid-cols-2 gap-4"><!--[-->`);
...
//# sourceMappingURL=index-CooCNHqf.mjs.map
