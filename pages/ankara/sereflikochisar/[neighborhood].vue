...
const { data: districtData } = await useAsyncData("sereflikochisar-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/ankara/sereflikochisar.json")
);

const cityName = "Ankara";
const citySlug = "ankara";
const districtName = "Şereflikoçhisar";
const districtSlug = "sereflikochisar";
