...
const { data: districtData } = await useAsyncData("bala-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/ankara/bala.json")
);

const cityName = "Ankara";
const citySlug = "ankara";
const districtName = "Bala";
const districtSlug = "bala";
