...
const pageDesc = computed(() => aydinData.value ? `${titleCase(aydinData.value.name)} iline bağlı ilçe ve mahallelerin posta kodlarını görmek için tıklayın!` : 'Posta Kodu Rehberi');
useHead({
title: pageTitle,
...
<div>
<h1 class="text-3xl font-bold text-slate-900 tracking-tight">{{ titleCase(aydinData.name) }} Posta Kodları</h1>
