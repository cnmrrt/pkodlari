...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: districtData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "kizilcahamam-details",
      () => $fetch("https://pkodlari.com/data/ankara/kizilcahamam.json")
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/ankara/kizilcahamam/[neighborhood].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_neighborhood_-Bzua9rn6.mjs.map
