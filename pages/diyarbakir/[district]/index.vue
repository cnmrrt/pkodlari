...
<p class="text-slate-500 text-sm font-medium uppercase tracking-wider">Diyarbakır</p>
</div>
</div>
...
:key="nItem.slug"
:to="`/diyarbakir/${districtSlug}/${nItem.slug}`"
...
<p>İlçe bulunamadı.</p>
<NuxtLink to="/diyarbakir" class="text-slate-900 underline mt-4 inline-block">Diyarbakır sayfasına dön</NuxtLink>
</div>
</template>
