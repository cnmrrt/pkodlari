...
const pageTitle = `Ardahan Posta Kodları ve İlçeleri ${currentYear}`;
const pageDesc = "Ardahan iline bağlı ilçe ve mahallelerin posta kodlarını görmek için tıklayın!";
...
<template>
    <div class="animate-in fade-in duration-500 max-w-4xl mx-auto">
        <div class="cityTitleContainer">
            ...
            <div>
                <h1>Ardahan Posta Kodları</h1>
                <p>{{ districts.length }} İLÇE</p>
            </div>
        </div>

        <div class="districts">
            <NuxtLink v-for="([distSlug, distItem]) in districts" :key="distSlug" :to="`/ardahan/${distSlug}`">
                <div>
