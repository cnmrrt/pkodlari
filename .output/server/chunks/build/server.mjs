import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, getCurrentInstance, inject, defineComponent, shallowRef, h, resolveComponent, computed, createElementBlock, provide, cloneVNode, useSSRContext, ref, Suspense, Fragment, createApp, mergeProps, withCtx, unref, createVNode, createTextVNode, shallowReactive, withAsyncContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, reactive, effectScope, toValue, defineAsyncComponent, getCurrentScope, toRef, nextTick, isReadonly, isRef, isShallow, isReactive, toRaw } from 'vue';
import { p as parseQuery, l as getContext, m as hasProtocol, i as joinURL, w as withQuery, n as isScriptProtocol, o as withTrailingSlash, q as withoutTrailingSlash, s as sanitizeStatusCode, $ as $fetch$1, r as createHooks, c as createError$1, t as executeAsync, v as defu } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-DOl00C08.mjs')
  },
  {
    name: "city",
    path: "/:city()",
    component: () => import('./index-KTkGZ2fF.mjs')
  },
  {
    name: "city-district",
    path: "/:city()/:district()",
    component: () => import('./index-BIal_7IY.mjs')
  },
  {
    name: "city-district-neighborhood",
    path: "/:city()/:district()/:neighborhood()",
    component: () => import('./_neighborhood_-DQB433L2.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Dj863BTm.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-NdWt1M4m.mjs'));
