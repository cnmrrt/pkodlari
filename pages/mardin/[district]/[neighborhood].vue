...
<p>{{ neighData.postaKodu }} posta kodu Mardin {{
...
<p>{{ titleCase(neighData.mahalle) }}, Mardin ilinin {{ titleCase(neighData.ilce) }} ilçesine bağlıdır. Posta kodu yapısı incelendiğinde                                                                                              ;</p>
<ol>
