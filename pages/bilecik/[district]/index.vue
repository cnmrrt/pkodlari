...
<template>
    <div v-if="isValid" class="animate-in fade-in duration-500 max-w-4xl mx-auto">
        ...
        <div class="neighborhoods-links-container">
            <NuxtLink v-for="nItem in neighs" :key="nItem.slug" :to="`/bilecik/${districtSlug}/${nItem.slug}`">
    ...
    <div v-else class="py-32 text-center text-slate-400">
        <p>İlçe bulunamadı.</p>
        <NuxtLink to="/bilecik" class="text-slate-900 underline mt-4 inline-block">Bilecik sayfasına dön</NuxtLink>
    </div>
</template>
