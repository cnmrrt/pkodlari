...
return osmaniyeData.value.find(item =>
...
text: `Osmaniye, ${titleCase(neighData.value.ilce)}, ${titleCase(neighData.value.mahalle)} mahallesinin posta kodu: ${neighData.value.postaKodu}`,
...
<NuxtLink to="/osmaniye" class="hover:text-slate-900 transition-colors">OSMANİYE</NuxtLink>
<ChevronRight class="w-3 h-3" />
<NuxtLink :to="`/osmaniye/${districtSlug}`" class="hover:text-slate-900 transition-colors">{{
...
<p class="text-slate-600">{{ neighData.postaKodu }} posta kodu Osmaniye {{
...
<p class="text-slate-600">Osmaniye {{
...
<p class="text-slate-600">{{ titleCase(neighData.mahalle) }}, Osmaniye ilinin {{ titleCase(neighData.ilce) }} ilçesine bağlıdır. Posta kodu yapısı incelendiğinde                                                                                            ;</p>
<ol>
...
<NuxtLink to="/osmaniye" class="mt-6 inline-block text-red-700 underline">Osmaniye Sayfasına Dön</NuxtLink>
</div>
</div>
</template>
