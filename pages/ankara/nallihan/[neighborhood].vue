...
const { data: districtData } = await useAsyncData("nallihan-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/ankara/nallihan.json")
);

const cityName = "Ankara";
const citySlug = "ankara";
const districtName = "Nallıhan";
const districtSlug = "nallihan";
