...
const pageDesc = "\xA1Haz clic aqu\xED para ver los c\xF3digos postales de los distritos y barrios de la provincia de Madrid!";
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const districts = computed(() => {
      if (!madridData.value) return [];
      const districtMap = {};
      madridData.value.forEach((item) => {
    ...
    const pageTitle = `C\xF3digos postales y distritos de Madrid ${currentYear}`;
    useHead({
      htmlAttrs: {
        lang: "es"
      },
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/es" }, {
      ...
      _push(`<div><h1>C\xF3digos postales de Madrid</h1><p>${ssrInterpolate(unref(districts).length)} DISTRITO</p></div></div><div class="districts"><!--[-->`);
      ssrRenderList(unref(districts), ([distSlug, distItem]) => {
        _push(ssrRenderComponent(_component_NuxtLink, {
          key: distSlug,
          to: `/es/madrid/${distSlug}`
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div${_scopeId}><h3${_scopeId}>${ssrInterpolate(unref(titleCase)(distItem.name))}</h3><p${_scopeId}>${ssrInterpolate(distItem.count)} vecindario</p></div>`);
              ...
              return [
                createVNode("div", null, [
                  ...
                  createVNode("p", null, toDisplayString(distItem.count) + " vecindario", 1)
                ]),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/es/madrid/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-dlWaHEK-.mjs.map
