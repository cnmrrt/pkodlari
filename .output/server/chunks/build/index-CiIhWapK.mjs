...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    useHead({
      title: computed(() => districtItem.value ? `${titleCase(districtItem.value.name)} Posta Kodlar\u0131 - Ankara` : "\u0130l\xE7e Bulunamad\u0131"),
      meta: [
        {
          name: "description",
          content: computed(() => {
            if (!districtItem.value) return "";
            return `Ankara ${titleCase(districtItem.value.name)} il\xE7esine ba\u011Fl\u0131 mahallelerin posta kodlar\u0131n\u0131 g\xF6rmek i\xE7in t\u0131klay\u0131n!`;
          })
        }
      ],
      script: [
...
//# sourceMappingURL=index-CiIhWapK.mjs.map
