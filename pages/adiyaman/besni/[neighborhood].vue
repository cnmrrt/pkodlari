...
const { data: adiyamanBesniData } = await useAsyncData("adiyaman-besni-data", () =>
  $fetch<any[]>("https://pkodlari.com/data/adiyaman/besni.json")
);
...
const otherNeighborhoods = computed(() => {
  ...
  return adiyamanBesniData.value
