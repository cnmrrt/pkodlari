...
const { data: giresunEspiyeData } = await useAsyncData("giresun-espiye-data", () =>
  $fetch<any[]>("https://pkodlari.com/data/giresun/espiye.json")
);
...
const otherNeighborhoods = computed(() => {
  ...
  return giresunEspiyeData.value
