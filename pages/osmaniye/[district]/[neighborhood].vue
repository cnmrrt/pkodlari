...
<p>{{ neighData.postaKodu }} posta kodu Osmaniye {{
...
<p>{{ titleCase(neighData.mahalle) }}, Osmaniye ilinin {{ titleCase(neighData.ilce) }} ilçesine bağlıdır. Posta kodu yapısı incelendiğinde                                                                                            ;</p>
<ol>
