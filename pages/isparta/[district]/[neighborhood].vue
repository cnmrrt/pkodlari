...
<p>{{ neighData.postaKodu }} posta kodu Isparta {{
...
<p>Posta kodu, bir adresin en spesifik bileşenidir. {{ titleCase(neighData.mahalle) }} için tanımlanan {{ neighData.postaKodu }} numarasını kullanmak şu aispartatajları sağlar:</p>
<ul>
...
<p>{{ titleCase(neighData.mahalle) }}, Isparta ilinin {{ titleCase(neighData.ilce) }} ilçesine bağlıdır. Posta kodu yapısı incelendiğinde                                                                                              ;</p>
<ol>
