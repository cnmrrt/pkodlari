...
const { data: districtData } = await useAsyncData("catalca-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/istanbul/catalca.json")
);

const cityName = "İstanbul";
const citySlug = "istanbul";
const districtName = "Çatalca";
const districtSlug = "catalca";
