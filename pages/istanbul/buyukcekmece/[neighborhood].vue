...
const { data: districtData } = await useAsyncData("buyukcekmece-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/istanbul/buyukcekmece.json")
);

const cityName = "İstanbul";
const citySlug = "istanbul";
const districtName = "Büyükçekmece";
const districtSlug = "buyukcekmece";
