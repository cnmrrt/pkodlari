...
const { data: districtData } = await useAsyncData("yenimahalle-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/ankara/yenimahalle.json")
);

const cityName = "Ankara";
const citySlug = "ankara";
const districtName = "Yenimahalle";
const districtSlug = "yenimahalle";
