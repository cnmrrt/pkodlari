...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: batmanData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "batman-data",
      () => $fetch("https://words-from-life-5cb26-default-rtdb.firebaseio.com/posta_kodlari_duzenlenmis/batman.json")
...
//# sourceMappingURL=_neighborhood_-D5B5f-YQ.mjs.map
