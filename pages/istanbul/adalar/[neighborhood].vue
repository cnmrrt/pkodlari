...
const { data: districtData } = await useAsyncData("adalar-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/istanbul/adalar.json")
);

const cityName = "İstanbul";
const citySlug = "istanbul";
const districtName = "Adalar";
const districtSlug = "adalar";
