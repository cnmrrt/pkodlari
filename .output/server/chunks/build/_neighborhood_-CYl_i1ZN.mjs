...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: gumushaneData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "gumushane-data",
      () => $fetch("https://words-from-life-5cb26-default-rtdb.firebaseio.com/posta_kodlari_duzenlenmis/gumushane.json")
...
//# sourceMappingURL=_neighborhood_-CYl_i1ZN.mjs.map
