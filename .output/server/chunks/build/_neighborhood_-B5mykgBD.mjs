...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: sakaryaData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "sakarya-data",
      () => $fetch("https://words-from-life-5cb26-default-rtdb.firebaseio.com/posta_kodlari_duzenlenmis/sakarya.json")
...
//# sourceMappingURL=_neighborhood_-B5mykgBD.mjs.map
