...
const { data: districtData } = await useAsyncData("esenyurt-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/istanbul/esenyurt.json")
);

const cityName = "İstanbul";
const citySlug = "istanbul";
const districtName = "Esenyurt";
const districtSlug = "esenyurt";
