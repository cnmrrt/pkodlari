...
const { data: balikesirDursunbeyData } = await useAsyncData("balikesir-dursunbey-data", () =>
  $fetch<any[]>("https://pkodlari.com/data/balikesir/dursunbey.json")
);
...
const otherNeighborhoods = computed(() => {
  ...
  return balikesirDursunbeyData.value
