...
<p>{{ neighData.postaKodu }} posta kodu Kilis {{
...
<p>{{ titleCase(neighData.mahalle) }}, Kilis ilinin {{ titleCase(neighData.ilce) }} ilçesine bağlıdır. Posta kodu yapısı incelendiğinde                                                                                               ;</p>
<ol>
