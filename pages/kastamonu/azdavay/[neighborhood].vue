...
const { data: kastamonuAzdavayData } = await useAsyncData("kastamonu-azdavay-data", () =>
  $fetch<any[]>("https://pkodlari.com/data/kastamonu/azdavay.json")
);
...
const otherNeighborhoods = computed(() => {
  ...
  return kastamonuAzdavayData.value
