...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: eskisehirData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "eskisehir-data",
      () => $fetch("https://words-from-life-5cb26-default-rtdb.firebaseio.com/posta_kodlari_duzenlenmis/eskisehir.json")
...
//# sourceMappingURL=_neighborhood_-BjJmakWS.mjs.map
