...
const { data: artvinYusufeliData } = await useAsyncData("artvin-yusufeli-data", () =>
  $fetch<any[]>("https://pkodlari.com/data/tr/artvin/yusufeli.json")
);
...
const otherNeighborhoods = computed(() => {
  ...
  return artvinYusufeliData.value
