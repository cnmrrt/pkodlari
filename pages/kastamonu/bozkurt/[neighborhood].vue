...
const { data: kastamonuBozkurtData } = await useAsyncData("kastamonu-bozkurt-data", () =>
  $fetch<any[]>(useRequestURL().origin + "/data/kastamonu/bozkurt.json")
);
...
const otherNeighborhoods = computed(() => {
  ...
  return kastamonuBozkurtData.value
