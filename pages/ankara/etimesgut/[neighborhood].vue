...
const { data: districtData } = await useAsyncData("etimesgut-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/ankara/etimesgut.json")
);

const cityName = "Ankara";
const citySlug = "ankara";
const districtName = "Etimesgut";
const districtSlug = "etimesgut";
