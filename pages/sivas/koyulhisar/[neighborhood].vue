...
const { data: sivasKoyulhisarData } = await useAsyncData("sivas-koyulhisar-data", () =>
  $fetch<any[]>("https://pkodlari.com/data/sivas/koyulhisar.json")
);
...
const otherNeighborhoods = computed(() => {
  ...
  return sivasKoyulhisarData.value
