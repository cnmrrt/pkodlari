...
const { data: kastamonuCideData } = await useAsyncData("kastamonu-cide-data", () =>
  $fetch<any[]>("https://pkodlari.com/data/kastamonu/cide.json")
);
...
const otherNeighborhoods = computed(() => {
  ...
  return kastamonuCideData.value
