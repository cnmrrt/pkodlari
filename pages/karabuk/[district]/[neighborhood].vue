...
<p class="text-slate-600">{{ neighData.postaKodu }} posta kodu Karabük {{
...
<p class="text-slate-600">Karabük {{
...
<p class="text-slate-600">{{ titleCase(neighData.mahalle) }}, Karabük ilinin {{ titleCase(neighData.ilce) }} ilçesine bağlıdır. Posta kodu yapısı incelendiğinde                                                                                            ;</p>
<ol>
