...
$fetch<any[]>('https://pkodlari.com/data/kastamonu/all.json')
)                                                                                                                   ;
...
<p>{{ neighData.postaKodu }} posta kodu Kastamonu {{
...
<p>{{ titleCase(neighData.mahalle) }}, Kastamonu ilinin {{ titleCase(neighData.ilce) }} ilçesine bağlıdır. Posta kodu yapısı incelendiğinde                                                                                           ;</p>
<ol>
