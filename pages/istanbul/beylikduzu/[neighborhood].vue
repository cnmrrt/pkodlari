...
const { data: districtData } = await useAsyncData("beylikduzu-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/istanbul/beylikduzu.json")
);

const cityName = "İstanbul";
const citySlug = "istanbul";
const districtName = "Beylikdüzü";
const districtSlug = "beylikduzu";
