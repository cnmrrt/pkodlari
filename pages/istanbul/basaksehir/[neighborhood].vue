...
const { data: districtData } = await useAsyncData("basaksehir-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/istanbul/basaksehir.json")
);

const cityName = "İstanbul";
const citySlug = "istanbul";
const districtName = "Başakşehir";
const districtSlug = "basaksehir";
