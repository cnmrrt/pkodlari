...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: osmaniyeData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "osmaniye-data",
      () => $fetch("https://words-from-life-5cb26-default-rtdb.firebaseio.com/posta_kodlari_duzenlenmis/osmaniye.json")
...
//# sourceMappingURL=_neighborhood_-DJGD3kR8.mjs.map
