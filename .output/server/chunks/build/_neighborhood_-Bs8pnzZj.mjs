...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: aydinData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "aydin-data",
      () => $fetch("https://words-from-life-5cb26-default-rtdb.firebaseio.com/posta_kodlari_duzenlenmis/aydin.json")
...
//# sourceMappingURL=_neighborhood_-Bs8pnzZj.mjs.map
