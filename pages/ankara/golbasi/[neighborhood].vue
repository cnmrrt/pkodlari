...
const { data: districtData } = await useAsyncData("golbasi-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/ankara/golbasi.json")
);

const cityName = "Ankara";
const citySlug = "ankara";
const districtName = "Gölbaşı";
const districtSlug = "golbasi";
