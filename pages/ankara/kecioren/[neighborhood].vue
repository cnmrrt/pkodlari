...
const { data: districtData } = await useAsyncData("kecioren-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/ankara/kecioren.json")
);

const cityName = "Ankara";
const citySlug = "ankara";
const districtName = "Keçiören";
const districtSlug = "kecioren";
