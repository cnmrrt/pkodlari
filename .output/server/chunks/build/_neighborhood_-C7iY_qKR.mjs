...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: balikesirData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "balikesir-data",
      () => $fetch("https://pkodlari.com/data/balikesir/all.json")
...
//# sourceMappingURL=_neighborhood_-C7iY_qKR.mjs.map
