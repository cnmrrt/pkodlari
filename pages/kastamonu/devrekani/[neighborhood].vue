...
const { data: kastamonuDevrekaniData } = await useAsyncData("kastamonu-devrekani-data", () =>
  $fetch<any[]>(useRequestURL().origin + "/data/kastamonu/devrekani.json")
);
...
const otherNeighborhoods = computed(() => {
  ...
  return kastamonuDevrekaniData.value
