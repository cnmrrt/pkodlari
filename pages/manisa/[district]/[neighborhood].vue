...
<p>{{ neighData.postaKodu }} posta kodu Manisa {{
...
<p>{{ titleCase(neighData.mahalle) }}, Manisa ilinin {{ titleCase(neighData.ilce) }} ilçesine bağlıdır. Posta kodu yapısı incelendiğinde                                                                                              ;</p>
<ol>
