      ...
      meta: [
        {
          ...
          content: computed(() => {
            ...
            return `Bal\u0131kesir ilinin ${titleCase(districtItem.value.name)} il\xE7esine ba\u011Fl\u0131 ${titleCase(neighItem.value.name)}'nin posta kodunu g\xF6rmek i\xE7in t\u0131klay\u0131n!`;
          })
        }
      ],
      script: [
...
//# sourceMappingURL=_neighborhood_-DlyBumsT.mjs.map
