...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div><h1>Yozgat Posta Kodlar\u0131</h1><p>${ssrInterpolate(unref(districts).length)} \u0130L\xC7E</p></div></div><div class="districts"><!--[-->`);
...
//# sourceMappingURL=index-ByU0TM0N.mjs.map
