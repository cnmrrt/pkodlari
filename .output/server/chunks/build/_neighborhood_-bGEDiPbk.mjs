...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: boluData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "bolu-data",
      () => $fetch("https://words-from-life-5cb26-default-rtdb.firebaseio.com/posta_kodlari_duzenlenmis/bolu.json")
...
//# sourceMappingURL=_neighborhood_-bGEDiPbk.mjs.map
