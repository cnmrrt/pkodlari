...
const { data: districtData } = await useAsyncData("kalecik-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/ankara/kalecik.json")
);

const cityName = "Ankara";
const citySlug = "ankara";
const districtName = "Kalecik";
const districtSlug = "kalecik";
