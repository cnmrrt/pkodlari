...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: rawNeighborhoods } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "pursaklar-data",
      () => $fetch("https://pkodlari.com/data/ankara/pursaklar.json")
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (isValid.value) {
        ...
        _push(`</div><p style="${ssrRenderStyle({ "margin-top": "25px" })}">Pursaklar, Ankara&#39;ya ba\u011Fl\u0131 bir il\xE7edir. 6 Mart 2008&#39;de il\xE7e olmu\u015Ftur.</p></div>`);
      } else {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/ankara/pursaklar/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-slC4iA44.mjs.map
