...
const { data: districtData } = await useAsyncData("silivri-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/istanbul/silivri.json")
);

const cityName = "İstanbul";
const citySlug = "istanbul";
const districtName = "Silivri";
const districtSlug = "silivri";
