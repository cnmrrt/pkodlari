...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: karabukData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "karabuk-data",
      () => $fetch("https://words-from-life-5cb26-default-rtdb.firebaseio.com/posta_kodlari_duzenlenmis/karabuk.json")
...
//# sourceMappingURL=_neighborhood_-B89xJvoz.mjs.map
