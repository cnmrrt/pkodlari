...
const { data: kastamonuAbanaData } = await useAsyncData("kastamonu-abana-data", () =>
  $fetch<any[]>(useRequestURL().origin + "/data/kastamonu/abana.json")
);
...
const otherNeighborhoods = computed(() => {
  ...
  return kastamonuAbanaData.value
