...
const { data: districtData } = await useAsyncData("bayrampasa-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/istanbul/bayrampasa.json")
);

const cityName = "İstanbul";
const citySlug = "istanbul";
const districtName = "Bayrampaşa";
const districtSlug = "bayrampasa";
