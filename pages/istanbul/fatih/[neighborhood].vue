...
const { data: districtData } = await useAsyncData("fatih-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/istanbul/fatih.json")
);

const cityName = "İstanbul";
const citySlug = "istanbul";
const districtName = "Fatih";
const districtSlug = "fatih";
