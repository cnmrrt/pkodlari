...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: mersinData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "mersin-data",
      () => $fetch("https://words-from-life-5cb26-default-rtdb.firebaseio.com/posta_kodlari_duzenlenmis/mersin.json")
...
//# sourceMappingURL=_neighborhood_--D88VSWE.mjs.map
