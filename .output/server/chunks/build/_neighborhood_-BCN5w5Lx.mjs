...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: kutahyaData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "kutahya-data",
      () => $fetch("https://words-from-life-5cb26-default-rtdb.firebaseio.com/posta_kodlari_duzenlenmis/kutahya.json")
...
//# sourceMappingURL=_neighborhood_-BCN5w5Lx.mjs.map
