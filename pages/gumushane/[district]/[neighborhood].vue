...
<p>{{ neighData.postaKodu }} posta kodu Gümüşhane {{
...
<p>{{ titleCase(neighData.mahalle) }}, Gümüşhane ilinin {{ titleCase(neighData.ilce) }} ilçesine bağlıdır. Posta kodu yapısı incelendiğinde                                                                                              ;</p>
<ol>
