...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: giresunData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "giresun-data",
      () => $fetch("https://pkodlari.com/data/giresun/all.json")
...
//# sourceMappingURL=_neighborhood_-Dsb8XEqZ.mjs.map
