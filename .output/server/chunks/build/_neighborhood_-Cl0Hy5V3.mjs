...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: samsunData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "samsun-data",
      () => $fetch("https://words-from-life-5cb26-default-rtdb.firebaseio.com/posta_kodlari_duzenlenmis/samsun.json")
...
//# sourceMappingURL=_neighborhood_-Cl0Hy5V3.mjs.map
