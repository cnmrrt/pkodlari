...
const { data: giresunGoreleData } = await useAsyncData("giresun-gorele-data", () =>
  $fetch<any[]>("https://pkodlari.com/data/giresun/gorele.json")
);

const cityName = "Giresun";
const citySlug = "giresun";
const districtName = "Görele";
...
const otherNeighborhoods = computed(() => {
  ...
  return giresunGoreleData.value
