...
useHead({
title: computed(() => ankaraData.value ? `${titleCase(ankaraData.value.name)} Posta Kodları` : 'Şehir Bulunamadı'),
meta: [
{
name: 'description',
content: computed(() => ankaraData.value ? `${titleCase(ankaraData.value.name)} iline bağlı ilçe ve mahallelerin posta kodlarını görmek için tıklayın!` : '')
}
],
script: [
{
