...
<p>{{ neighData.postaKodu }} posta kodu Aksaray {{
...
<p>{{ titleCase(neighData.mahalle) }}, Aksaray ilinin {{ titleCase(neighData.ilce) }} ilçesine bağlıdır. Posta kodu yapısı incelendiğinde                                                                                              ;</p>
<ol>
