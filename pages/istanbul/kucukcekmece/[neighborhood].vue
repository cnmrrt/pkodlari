...
const { data: districtData } = await useAsyncData("kucukcekmece-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/istanbul/kucukcekmece.json")
);

const cityName = "İstanbul";
const citySlug = "istanbul";
const districtName = "Küçükçekmece";
const districtSlug = "kucukcekmece";
