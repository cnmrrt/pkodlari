...
const { data: districtData } = await useAsyncData("kahramankazan-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/ankara/kahramankazan.json")
);

const cityName = "Ankara";
const citySlug = "ankara";
const districtName = "Kahramankazan";
const districtSlug = "kahramankazan";
