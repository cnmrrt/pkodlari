...
const districtName = "\u015Eile";
const districtSlug = "sile";
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: istanbulSileData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "istanbul-sile-data",
      () => $fetch("https://pkodlari.com/data/istanbul/sile.json")
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/istanbul/sile/[neighborhood].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_neighborhood_-D79S19xS.mjs.map
