...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: muglaData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "mugla-data",
      () => $fetch("https://words-from-life-5cb26-default-rtdb.firebaseio.com/posta_kodlari_duzenlenmis/mugla.json")
...
//# sourceMappingURL=_neighborhood_-BnlUtpSf.mjs.map
