...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: tokatData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "tokat-data",
      () => $fetch("https://words-from-life-5cb26-default-rtdb.firebaseio.com/posta_kodlari_duzenlenmis/tokat.json")
...
//# sourceMappingURL=_neighborhood_-kALzW1Jw.mjs.map
