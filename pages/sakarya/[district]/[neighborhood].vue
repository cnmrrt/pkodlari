...
<p>{{ neighData.postaKodu }} posta kodu Sakarya {{
...
<p>{{ titleCase(neighData.mahalle) }}, Sakarya ilinin {{ titleCase(neighData.ilce) }} ilçesine bağlıdır. Posta kodu yapısı incelendiğinde                                                                                              ;</p>
<ol>
