...
<p>{{ neighData.postaKodu }} posta kodu Bitlis {{
...
<p>{{ titleCase(neighData.mahalle) }}, Bitlis ilinin {{ titleCase(neighData.ilce) }} ilçesine bağlıdır. Posta kodu yapısı incelendiğinde                                                                                              ;</p>
<ol>
