...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: samsunData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "samsun-data",
      () => $fetch("https://pkodlari.com/data/samsun.json")
    ...
    const neighData = computed(() => {
      if (!samsunData.value) return null;
      return samsunData.value.find(
    ...
    const pageTitle = computed(() => neighData.value ? `${titleCase(neighData.value.mahalle)} Posta Kodu (${titleCase(neighData.value.ilce)}/Samsun)` : "Posta Kodu Bulunamad\u0131");
    const pageDesc = computed(() => neighData.value ? `Samsun ilinin ${titleCase(neighData.value.ilce)} il\xE7esine ba\u011Fl\u0131 ${titleCase(neighData.value.mahalle)}'nin posta kodunu g\xF6rmek i\xE7in t\u0131klay\u0131n!` : "Posta Kodu Rehberi");
    useHead({
      title: pageTitle,
            ...
            children: JSON.stringify({
              ...
              "itemListElement": [
                ...
                },
                {
                  ...
                  "position": 2,
                  "name": "Samsun",
                  "item": "https://pkodlari.com/samsun"
                },
                {
                  "@type": "ListItem",
                  "position": 3,
                  "name": titleCase(neighData.value.ilce),
                  "item": `https://pkodlari.com/samsun/${districtSlug.value}`
                },
                {
                  "@type": "ListItem",
                  "position": 4,
                  "name": titleCase(neighData.value.mahalle),
                  "item": `https://pkodlari.com/samsun/${districtSlug.value}/${neighborhoodSlug.value}`
                }
              ]
            })
          };
          ...
          return {
            ...
            children: JSON.stringify({
              ...
              "mainEntity": [{
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": `${neighData.value.postaKodu} posta kodu Samsun ${titleCase(neighData.value.ilce)} ${titleCase(neighData.value.mahalle)}'ne aittir.`
                }
              }]
            })
          };
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (isValid.value) {
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`Samsun Sayfas\u0131na D\xF6n`);
            } else {
              return [
                createTextVNode("Samsun Sayfas\u0131na D\xF6n")
              ];
            }
          }),
          _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/samsun/[district]/[neighborhood].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_neighborhood_-CIouZwfB.mjs.map
