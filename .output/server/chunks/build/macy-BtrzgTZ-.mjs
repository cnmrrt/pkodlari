...
var require_macy_003 = __commonJS({
  "_nuxt/macy-BtrzgTZ-.js"(exports, module) {
    !(function(t, n) {
      ...
      function e(t2, n2) {
        ...
        if ((void 0).Promise) return A(t2, n2, e2);
      ...
      function i(t2) {
        var n2 = t2.useContainerForBreakpoints ? t2.container.clientWidth : (void 0).innerWidth, e2 = { columns: t2.columns };
      ...
      h.prototype.byCss = function(t2, n2) {
        return (n2 || void 0).querySelectorAll(t2);
      }, h.prototype.selectors = {}, h.prototype.selectors[/^\.[\w\-]+$/] = function(t2) {
        return (void 0).getElementsByClassName(t2.substring(1));
      }, h.prototype.selectors[/^\w+$/] = function(t2) {
        return (void 0).getElementsByTagName(t2);
      }, h.prototype.selectors[/^\#[\w\-]+$/] = function(t2) {
        return (void 0).getElementById(t2.substring(1));
      };
      ...
      var g = function(t2) {
        ...
        (void 0).addEventListener("resize", t2.resizer), t2.on(t2.constants.EVENT_IMAGE_LOAD, function() {
        ...
        return (void 0).getComputedStyle(t2, null).getPropertyValue(n2);
      }, M = function(t2, n2) {
        var e2 = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
      ...
      !(function() {
        try {
          (void 0).createElement("a").querySelector(":scope *");
        } catch (t2) {
          !(function() {
            function t3(t4) {
              return function(e3) {
      ...
      return q.init = function(t2) {
        ...
        (void 0).removeEventListener("resize", this.resizer), v(this.container.children, function(t2) {
          t2.removeAttribute("data-macy-complete"), t2.removeAttribute("style");
        }), this.container.removeAttribute("style");
      }, q.prototype.reInit = function() {
        this.recalculate(true, true), this.emit(this.constants.EVENT_INITIALIZED), (void 0).addEventListener("resize", this.resizer), this.container.style.position = "relative";
...
const macyBtrzgTZ_ = require_macy_003();

export { macyBtrzgTZ_ as default };
//# sourceMappingURL=macy-BtrzgTZ-.mjs.map
