...
const pageDesc = computed(() => bursaData.value ? `${titleCase(bursaData.value.name)} iline bağlı ilçe ve mahallelerin posta kodlarını görmek için tıklayın!` : 'Posta Kodu Rehberi');
useHead({
title: pageTitle,
...
<div>
<h1 class="text-3xl font-bold text-slate-900 tracking-tight">{{ titleCase(bursaData.name) }} Posta Kodları</h1>
