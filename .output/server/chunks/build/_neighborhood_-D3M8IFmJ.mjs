...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: elazigData } = ([__temp, __restore] = withAsyncContext(async () => useAsyncData("elazig-specific-data", async () => {
      const response = await $fetch("https://pkodlari.com/data/elazig.json");
      const cityObj = {
        name: "ELAZI\u011E",
        districts: {}
      };
    ...
    const districtItem = computed(() => {
      var _a;
      return (_a = elazigData.value) == null ? void 0 : _a.districts[distSlug.value];
    });
    ...
    const pageDesc = computed(() => districtItem.value && neighItem.value ? `Elaz\u0131\u011F ilinin ${titleCase(districtItem.value.name)} il\xE7esine ba\u011Fl\u0131 ${titleCase(neighItem.value.name)}'nin posta kodunu g\xF6rmek i\xE7in t\u0131klay\u0131n!` : "Posta Kodu Rehberi");
    useHead({
      title: pageTitle,
            ...
            children: JSON.stringify({
              ...
              "itemListElement": [
                ...
                },
                {
                  ...
                  "item": `https://postakodu.com/elazig/${distSlug.value}/${neighborhoodSlug.value}`
                }
              ]
            })
          };
...
//# sourceMappingURL=_neighborhood_-D3M8IFmJ.mjs.map
