...
<NuxtLink to="/bolu" ><ArrowLeft/></NuxtLink>
<div>
...
:key="nItem.slug"
:to="`/bolu/${districtSlug}/${nItem.slug}`"
...
<p>İlçe bulunamadı.</p>
<NuxtLink to="/bolu" class="text-slate-900 underline mt-4 inline-block">Bolu sayfasına dön</NuxtLink>
</div>
</template>
