...
$fetch<any[]>('https://pkodlari.com/data/kutahya.json')
)                                                                                                                 ;
...
return kutahyaData.value.find(item =>
...
text: `Kütahya, ${titleCase(neighData.value.ilce)}, ${titleCase(neighData.value.mahalle)} mahallesinin posta kodu: ${neighData.value.postaKodu}`,
...
<NuxtLink to="/kutahya" class="hover:text-slate-900 transition-colors">KÜTAHYA</NuxtLink>
<ChevronRight class="w-3 h-3" />
<NuxtLink :to="`/kutahya/${districtSlug}`" class="hover:text-slate-900 transition-colors">{{
...
<p class="text-slate-600">{{ neighData.postaKodu }} posta kodu Kütahya {{
...
<p class="text-slate-600">Kütahya {{
...
<p class="text-slate-600">{{ titleCase(neighData.mahalle) }}, Kütahya ilinin {{ titleCase(neighData.ilce) }} ilçesine bağlıdır. Posta kodu yapısı incelendiğinde                                                                                            ;</p>
<ol>
...
<NuxtLink to="/kutahya" class="mt-6 inline-block text-red-700 underline">Kütahya Sayfasına Dön</NuxtLink>
</div>
</div>
</template>
