...
const neighItem = computed(() => {
  ...
  return (
    districtItem.value.neighborhoods.find(
...
<template>
    ...
    <div class="bg-white border border-slate-200 rounded-[2rem] p-8 md:p-12 shadow-sm">
      <div class="text-center mb-10">
        ...
        <p class="text-slate-500 font-medium uppercase tracking-widest text-sm">
          {{ titleCase(districtItem.name) }}, {{ cityName }}
        </p>
      </div>
 ...
 <div class="mt-8 text-center mb-8">
      ...
      <p class="text-slate-600">
        {{ neighItem.zipCode }} posta kodu {{ cityName }}
    ...
    <div class="mt-8 text-center mb-8">
      ...
      <p class="text-slate-600">
        {{ cityName }} {{ titleCase(districtItem.name) }}
    ...
    <div class="mt-8 text-center mb-8">
      ...
      <p class="text-slate-600">
        {{ titleCase(neighItem.name) }}, {{ cityName }} ilinin
