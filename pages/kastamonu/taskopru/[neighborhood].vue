...
const { data: kastamonuTaskopruData } = await useAsyncData("kastamonu-taskopru-data", () =>
  $fetch<any[]>(useRequestURL().origin + "/data/kastamonu/taskopru.json")
);

const cityName = "Kastamonu";
const citySlug = "kastamonu";
const districtName = "Taşköprü";
...
const otherNeighborhoods = computed(() => {
  ...
  return kastamonuTaskopruData.value
