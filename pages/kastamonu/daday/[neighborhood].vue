...
const { data: kastamonuDadayData } = await useAsyncData("kastamonu-daday-data", () =>
  $fetch<any[]>("https://pkodlari.com/data/kastamonu/daday.json")
);
...
const otherNeighborhoods = computed(() => {
  ...
  return kastamonuDadayData.value
