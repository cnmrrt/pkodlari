...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: adiyamanData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "adiyaman-data",
      () => $fetch("https://pkodlari.com/data/adiyaman/all.json")
...
//# sourceMappingURL=_neighborhood_-B61ejw-y.mjs.map
