...
const { data: districtData } = await useAsyncData("atasehir-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/istanbul/atasehir.json")
);

const cityName = "İstanbul";
const citySlug = "istanbul";
const districtName = "Ataşehir";
const districtSlug = "atasehir";
