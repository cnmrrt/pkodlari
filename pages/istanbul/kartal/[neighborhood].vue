...
const { data: districtData } = await useAsyncData("kartal-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/istanbul/kartal.json")
);

const cityName = "İstanbul";
const citySlug = "istanbul";
const districtName = "Kartal";
const districtSlug = "kartal";
