...
const { data: districtData } = await useAsyncData("sultanbeyli-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/istanbul/sultanbeyli.json")
);

const cityName = "İstanbul";
const citySlug = "istanbul";
const districtName = "Sultanbeyli";
const districtSlug = "sultanbeyli";
