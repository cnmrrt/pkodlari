...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: antalyaData } = ([__temp, __restore] = withAsyncContext(async () => useAsyncData("antalya-specific-data", async () => {
      const response = await $fetch("https://words-from-life-5cb26-default-rtdb.firebaseio.com/posta_kodlari_duzenlenmis/antalya.json");
      const cityObj = {
        name: "ANTALYA",
        districts: {}
      };
    ...
    const districtItem = computed(() => {
      var _a;
      return (_a = antalyaData.value) == null ? void 0 : _a.districts[distSlug.value];
    });
    ...
    const pageDesc = computed(() => districtItem.value && neighItem.value ? `Antalya ilinin ${titleCase(districtItem.value.name)} il\xE7esine ba\u011Fl\u0131 ${titleCase(neighItem.value.name)}'nin posta kodunu g\xF6rmek i\xE7in t\u0131klay\u0131n!` : "Posta Kodu Rehberi");
    useHead({
      title: pageTitle,
...
//# sourceMappingURL=_neighborhood_-9byd1426.mjs.map
