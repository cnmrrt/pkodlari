...
const { data: districtData } = await useAsyncData("bagcilar-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/istanbul/bagcilar.json")
);

const cityName = "İstanbul";
const citySlug = "istanbul";
const districtName = "Bağcılar";
const districtSlug = "bagcilar";
