...
const { data: districtData } = await useAsyncData("uskudar-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/istanbul/uskudar.json")
);

const cityName = "İstanbul";
const citySlug = "istanbul";
const districtName = "Üsküdar";
const districtSlug = "uskudar";
