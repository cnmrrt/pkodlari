...
import { defineComponent, inject, ref, computed, mergeProps, withCtx, unref, createVNode, toDisplayString, useSSRContext } from 'file:///Users/mac/Desktop/pkodlari/node_modules/vue/index.mjs';
...
import { ArrowLeft, Search, ChevronRight, MapPin } from 'file:///Users/mac/Desktop/pkodlari/node_modules/lucide-vue-next/dist/cjs/lucide-vue-next.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const pageTitle = computed(() => districtItem.value ? `${titleCase(districtItem.value.name)} Posta Kodlar\u0131` : "\u0130l\xE7e Bulunamad\u0131");
    const pageDesc = computed(() => {
      if (!cityItem.value || !districtItem.value) return "Posta Kodu Rehberi";
      return `${titleCase(cityItem.value.name)} ilinin ${titleCase(districtItem.value.name)} il\xE7esine ba\u011Fl\u0131 mahallelerin posta kodlar\u0131n\u0131 g\xF6rmek i\xE7in t\u0131klay\u0131n!`;
    });
    useHead({
      title: pageTitle,
...
//# sourceMappingURL=index-QTkSBsrJ.mjs.map
