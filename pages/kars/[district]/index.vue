...
<NuxtLink to="/kars" class="text-slate-400 hover:text-slate-900 transition-colors">
...
:key="nItem.slug"
:to="`/kars/${districtSlug}/${nItem.slug}`"
...
<p>İlçe bulunamadı.</p>
<NuxtLink to="/kars" class="text-slate-900 underline mt-4 inline-block">Kars sayfasına dön</NuxtLink>
</div>
</template>
