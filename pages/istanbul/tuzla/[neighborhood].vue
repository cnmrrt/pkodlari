...
const { data: districtData } = await useAsyncData("tuzla-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/istanbul/tuzla.json")
);

const cityName = "İstanbul";
const citySlug = "istanbul";
const districtName = "Tuzla";
const districtSlug = "tuzla";
