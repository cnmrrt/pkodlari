...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: ardahanData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "ardahan-data",
      () => $fetch("https://pkodlari.com/data/ardahan.json")
    ...
    const neighData = computed(() => {
      if (!ardahanData.value) return null;
      return ardahanData.value.find(
    ...
    const pageTitle = computed(
      ...
      )}/Ardahan)` : "Posta Kodu Bulunamad\u0131"
    );
    const pageDesc = computed(
      () => neighData.value ? `Ardahan ilinin ${titleCase(neighData.value.ilce)} il\xE7esine ba\u011Fl\u0131 ${titleCase(
            ...
            children: JSON.stringify({
              ...
              itemListElement: [
                ...
                },
                {
                  ...
                  position: 2,
                  name: "Ardahan",
                  item: "https://pkodlari.com/ardahan"
                },
                {
                  "@type": "ListItem",
                  position: 3,
                  name: titleCase(neighData.value.ilce),
                  item: `https://pkodlari.com/ardahan/${districtSlug.value}`
                },
                {
                  "@type": "ListItem",
                  position: 4,
                  name: titleCase(neighData.value.mahalle),
                  item: `https://pkodlari.com/ardahan/${districtSlug.value}/${neighborhoodSlug.value}`
                }
              ]
            })
          };
              ...
              mainEntity: [
                {
                  ...
                  acceptedAnswer: {
                    "@type": "Answer",
                    text: `${neighData.value.postaKodu} posta kodu Ardahan ${titleCase(
                      neighData.value.ilce
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (isValid.value) {
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`Ardahan Sayfas\u0131na D\xF6n`);
            } else {
              return [
                createTextVNode("Ardahan Sayfas\u0131na D\xF6n")
              ];
            }
          }),
          _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/ardahan/[district]/[neighborhood].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_neighborhood_-pDD36I8_.mjs.map
