  ...
  async setup(__props) {
    ...
    useHead({
      ...
      meta: [
        {
          name: "description",
          content: computed(() => ankaraData.value ? `${titleCase(ankaraData.value.name)} iline ba\u011Fl\u0131 il\xE7e ve mahallelerin posta kodlar\u0131n\u0131 g\xF6rmek i\xE7in t\u0131klay\u0131n!` : "")
        }
      ],
      script: [
        {
...
//# sourceMappingURL=index-C15OYtZi.mjs.map
