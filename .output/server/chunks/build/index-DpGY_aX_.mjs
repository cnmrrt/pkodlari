  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (isValid.value) {
        ...
        _push(ssrRenderComponent(_component_NuxtLink, { to: "/aksaray" }, {
        ...
        _push(`<div><h1>${ssrInterpolate(unref(titleCase)(districtData.value.name))} Posta Kodlar\u0131</h1><p>Aksaray</p></div></div><div class="neighborhood-search-container">`);
...
//# sourceMappingURL=index-DpGY_aX_.mjs.map
