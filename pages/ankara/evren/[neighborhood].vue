...
const { data: districtData } = await useAsyncData("evren-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/ankara/evren.json")
);

const cityName = "Ankara";
const citySlug = "ankara";
const districtName = "Evren";
const districtSlug = "evren";
