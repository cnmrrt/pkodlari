...
import { defineComponent, ref, withAsyncContext, computed, mergeProps, unref, withCtx, createVNode, toDisplayString, createTextVNode, useSSRContext } from 'vue';
...
import { Check, Copy, Share2, ChevronRight, MapPin } from 'lucide-vue-next';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: amasyaData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "amasya-data",
      () => $fetch("https://pkodlari.com/data/amasya.json")
    ...
    const neighData = computed(() => {
      if (!amasyaData.value) return null;
      return amasyaData.value.find(
    ...
    const pageTitle = computed(() => neighData.value ? `${titleCase(neighData.value.mahalle)} Posta Kodu (${titleCase(neighData.value.ilce)}/Amasya)` : "Posta Kodu Bulunamad\u0131");
    const pageDesc = computed(() => neighData.value ? `Amasya ilinin ${titleCase(neighData.value.ilce)} il\xE7esine ba\u011Fl\u0131 ${titleCase(neighData.value.mahalle)}'nin posta kodunu g\xF6rmek i\xE7in t\u0131klay\u0131n!` : "Posta Kodu Rehberi");
    useHead({
      title: pageTitle,
            ...
            children: JSON.stringify({
              ...
              "itemListElement": [
                ...
                },
                {
                  ...
                  "position": 2,
                  "name": "Amasya",
                  "item": "https://pkodlari.com/amasya"
                },
                {
                  "@type": "ListItem",
                  "position": 3,
                  "name": titleCase(neighData.value.ilce),
                  "item": `https://pkodlari.com/amasya/${districtSlug.value}`
                },
                {
                  "@type": "ListItem",
                  "position": 4,
                  "name": titleCase(neighData.value.mahalle),
                  "item": `https://pkodlari.com/amasya/${districtSlug.value}/${neighborhoodSlug.value}`
                }
              ]
            })
          };
          ...
          return {
            ...
            children: JSON.stringify({
              ...
              "mainEntity": [{
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": `${neighData.value.postaKodu} posta kodu Amasya ${titleCase(neighData.value.ilce)} ${titleCase(neighData.value.mahalle)}'ne aittir.`
                }
              }]
            })
          };
    ...
    const otherNeighborhoods = computed(() => {
      if (!amasyaData.value || !neighData.value) return [];
      return amasyaData.value.filter((item) => slugify(item.ilce || titleCase(neighData.ilce)) === districtSlug).map((item) => ({
        name: item.mahalle,
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (isValid.value) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "main-content-neighborhood animate-in fade-in" }, _attrs))}><nav class="breadcrumb"><a href="/" class="hover:text-slate-900 transition-colors">T\xDCRK\u0130YE</a><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right-icon w-3 h-3"><path d="m9 18 6-6-6-6"></path></svg><a href="/amasya" class="hover:text-slate-900 transition-colors">AMASYA</a><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right-icon w-3 h-3"><path d="m9 18 6-6-6-6"></path></svg><a${ssrRenderAttr("href", `/amasya/${districtSlug.value}/`)} class="hover:text-slate-900 transition-colors">${ssrInterpolate(unref(titleCase)(neighData.value.ilce))}</a></nav><div class="main-info-container"><div class="main-info-title-container"><div class="main-info-logo"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0"></path><circle cx="12" cy="10" r="3"></circle></svg></div><h1>${ssrInterpolate(unref(titleCase)(neighData.value.mahalle))}</h1><p class="main-info-subtitle">${ssrInterpolate(unref(titleCase)(neighData.value.ilce))}, Amasya</p></div><div class="post-code-view-container"><div class="sub-post-code-view-container"><p>POSTA KODU</p><div class="postCode">${ssrInterpolate(neighData.value.postaKodu)}</div><button class="${ssrRenderClass([copied.value ? "green-btn" : "black-btn", "copy-btn active:scale-95"])}">`);
        if (copied.value) {
          _push(ssrRenderComponent(unref(Check), null, null, _parent));
        } else {
          _push(ssrRenderComponent(unref(Copy), null, null, _parent));
        }
        _push(` ${ssrInterpolate(copied.value ? "KOPYALANDI" : "KODU KOPYALA")}</button></div><div class="btn-bg">${ssrInterpolate(neighData.value.postaKodu.substring(0, 2))}</div></div></div><div class="share-btn"><button>`);
        ...
        if (otherNeighborhoods.value.length) {
          ...
          ssrRenderList(otherNeighborhoods.value, (neigh) => {
            _push(ssrRenderComponent(_component_NuxtLink, {
              key: neigh.slug,
              to: `/${citySlug}/${districtSlug.value}/${neigh.slug}`
            }, {
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`Amasya Sayfas\u0131na D\xF6n`);
            } else {
              return [
                createTextVNode("Amasya Sayfas\u0131na D\xF6n")
              ];
            }
          }),
          _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/amasya/[district]/[neighborhood].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_neighborhood_-ysM1qSkC.mjs.map
