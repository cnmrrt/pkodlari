...
<p class="text-slate-600">{{ neighData.postaKodu }} posta kodu Çanakkale {{
...
<p class="text-slate-600">Çanakkale {{
...
<p class="text-slate-600">{{ titleCase(neighData.mahalle) }}, Çanakkale ilinin {{ titleCase(neighData.ilce) }} ilçesine bağlıdır. Posta kodu yapısı incelendiğinde                                                                                          ;</p>
<ol>
