...
<p>{{ neighData.postaKodu }} posta kodu Kütahya {{
...
<p>{{ titleCase(neighData.mahalle) }}, Kütahya ilinin {{ titleCase(neighData.ilce) }} ilçesine bağlıdır. Posta kodu yapısı incelendiğinde                                                                                            ;</p>
<ol>
