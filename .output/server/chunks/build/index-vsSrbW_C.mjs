...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: rawNeighborhoods } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "avcilar-data",
      () => $fetch("https://pkodlari.com/data/istanbul/avcilar.json")
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/istanbul/avcilar/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-vsSrbW_C.mjs.map
