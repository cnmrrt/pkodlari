...
const districtName = "S\u0131nd\u0131rg\u0131";
const districtSlug = "sindirgi";
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: balikesirS\u0131nd\u0131rg\u0131Data } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "balikesir-sindirgi-data",
      () => $fetch(useRequestURL().origin + "/data/balikesir/sindirgi.json")
    )), __temp = await __temp, __restore(), __temp);
    const neighborhoodSlug = computed(() => route.params.neighborhood);
    const neighData = computed(() => {
      if (!balikesirS\u0131nd\u0131rg\u0131Data.value) return null;
      return balikesirS\u0131nd\u0131rg\u0131Data.value.find(
    ...
    const otherNeighborhoods = computed(() => {
      if (!balikesirS\u0131nd\u0131rg\u0131Data.value || !neighData.value) return [];
      return balikesirS\u0131nd\u0131rg\u0131Data.value.filter((item) => slugify(item.ilce || districtName) === districtSlug).map((item) => ({
        name: item.mahalle,
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/balikesir/sindirgi/[neighborhood].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_neighborhood_-COHlg1qs.mjs.map
