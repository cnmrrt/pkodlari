...
const pageTitle = "İzmir Konak Posta Kodları";
const pageDesc = "İzmir ilinin Konak ilçesine bağlı mahallelerin posta kodlarını görmek için tıklayın!";
useHead({
  title: pageTitle,
        ...
        children: JSON.stringify({
          ...
          itemListElement: [
            ...
            },
            {
              "@type": "ListItem",
              position: 2,
              name: "İzmir Posta Kodları",
              item: `https://pkodlari.com/izmir`,
            },
            {
              "@type": "ListItem",
              position: 3,
              name: "İzmir Konak Posta Kodları",
