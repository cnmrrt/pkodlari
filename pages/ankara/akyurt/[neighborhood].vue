...
const { data: districtData } = await useAsyncData("akyurt-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/ankara/akyurt.json")
);

const cityName = "Ankara";
const citySlug = "ankara";
const districtName = "Akyurt";
const districtSlug = "akyurt";
...
<p>{{ titleCase(neighData.mahalle) }}, Ağrı ilinin {{ titleCase(neighData.ilce) }} ilçesine bağlıdır. Posta kodunun ilk 2 hanesi il plaka kodunu, son 3 hanesi ise ilçe ve mahalle dağıtım bölgesini temsil eder.</p>
</div>
  </div>
