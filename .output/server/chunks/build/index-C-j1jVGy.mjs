...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const filter = ref("");
    const { data: agriData } = ([__temp, __restore] = withAsyncContext(async () => useAsyncData("agri-specific-data", async () => {
      const response = await $fetch("https://pkodlari.com/data/agri.json");
      const cityObj = {
        name: "A\u011ERI",
        districts: {}
      };
    ...
    const districtItem = computed(() => {
      var _a;
      return (_a = agriData.value) == null ? void 0 : _a.districts[distSlug.value];
    });
    const pageTitle = computed(() => districtItem.value ? `${titleCase(districtItem.value.name)} Posta Kodlar\u0131 - A\u011Fr\u0131` : "\u0130l\xE7e Bulunamad\u0131");
    const pageDesc = computed(() => districtItem.value ? `A\u011Fr\u0131 ${titleCase(districtItem.value.name)} il\xE7esine ba\u011Fl\u0131 mahallelerin posta kodlar\u0131n\u0131 g\xF6rmek i\xE7in t\u0131klay\u0131n!` : "Posta Kodu Rehberi");
    useHead({
      title: pageTitle,
            ...
            children: JSON.stringify({
              ...
              "itemListElement": [
                ...
                },
                {
                  ...
                  "position": 2,
                  "name": "A\u011Fr\u0131",
                  "item": `https://postakodu.com/agri`
                },
                {
                  "@type": "ListItem",
                  "position": 3,
                  "name": titleCase(districtItem.value.name),
                  "item": `https://postakodu.com/agri/${distSlug.value}`
                }
              ]
            })
          };
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (isValid.value) {
        ...
        _push(`<div><h1 class="text-3xl font-bold text-slate-900 tracking-tight">${ssrInterpolate(("titleCase" in _ctx ? _ctx.titleCase : unref(titleCase))(districtItem.value.name))} Posta Kodlar\u0131</h1><p class="text-slate-500 text-sm font-medium uppercase tracking-wider">A\u011ERI</p></div></div><div class="relative w-full md:w-64">`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/agri/[district]/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-C-j1jVGy.mjs.map
