...
const { data: adiyamanData } = await useAsyncData("adiyaman-data", () =>
  $fetch<any[]>("https://pkodlari.com/data/adiyaman/all.json")
);
...
const pageDesc = computed(() =>
  neighData.value
    ? `Adıyaman ilinin ${titleCase(neighData.value.ilce)} ilçesine bağlı ${titleCase(
...
const share = () => {
  if (navigator.share && neighData.value) {
    navigator.share({
      ...
      text: `Adıyaman, ${titleCase(neighData.value.ilce)}, ${titleCase(
        neighData.value.mahalle
...
<template>
  <div v-if="isValid" class="main-content-neighborhood animate-in fade-in">
    <nav class="breadcrumb">
      ...
      <ChevronRight class="w-3 h-3" />
      <NuxtLink :to="`/adiyaman/${districtSlug}`" class="hover:text-slate-900 transition-colors">{{
    ...
    <div class="main-info-container">
      <div class="main-info-title-container">
        ...
        <p class="main-info-subtitle">
          {{ titleCase(neighData.ilce) }}, Adıyaman
        </p>
      </div>
    ...
    <div class="page-text">
      ...
      <p>
        {{ neighData.postaKodu }} posta kodu Adıyaman {{ titleCase(neighData.ilce) }}
    ...
    <div class="page-text">
      ...
      <p>
        Adıyaman {{ titleCase(neighData.ilce) }} {{ titleCase(neighData.mahalle) }}'ne ait
    ...
    <div class="page-text">
      ...
      <p>
        {{ titleCase(neighData.mahalle) }}, Adıyaman ilinin
