import { a as useRoute, u as useAsyncData, s as slugify, f as findMapValue, t as titleCase, _ as __nuxt_component_0 } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: afyonData } = ([__temp, __restore] = withAsyncContext(async () => useAsyncData("afyonkarahisar-specific-data", async () => {
      const response = await $fetch("https://words-from-life-5cb26-default-rtdb.firebaseio.com/posta_kodlari_duzenlenmis/afyonkarahisar.json");
      const cityObj = {
        name: "AFYONKARAH\u0130SAR",
        districts: {}
      };
    ...
    const districtItem = computed(() => {
      var _a;
      return (_a = afyonData.value) == null ? void 0 : _a.districts[distSlug.value];
    });
    ...
    const pageDesc = computed(() => districtItem.value && neighItem.value ? `Afyonkarahisar ilinin ${titleCase(districtItem.value.name)} il\xE7esine ba\u011Fl\u0131 ${titleCase(neighItem.value.name)}'nin posta kodunu g\xF6rmek i\xE7in t\u0131klay\u0131n!` : "Posta Kodu Rehberi");
    useHead({
      title: pageTitle,
            ...
            children: JSON.stringify({
              ...
              "itemListElement": [
                ...
                },
                {
                  ...
                  "item": `https://postakodu.com/afyonkarahisar/${distSlug.value}`
                },
                {
                  "@type": "ListItem",
                  "position": 4,
                  "name": titleCase(neighItem.value.name),
                  "item": `https://postakodu.com/afyonkarahisar/${distSlug.value}/${neighborhoodSlug.value}`
                }
              ]
            })
          };
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (isValid.value) {
        ...
        _push(ssrRenderComponent(unref(ChevronRight), { class: "w-3 h-3" }, null, _parent));
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: `/afyonkarahisar/${distSlug.value}`,
          class: "hover:text-slate-900 transition-colors"
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
...
//# sourceMappingURL=_neighborhood_-Dc4Dp4f0.mjs.map
