...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: yozgatData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "yozgat-data",
      () => $fetch("https://words-from-life-5cb26-default-rtdb.firebaseio.com/posta_kodlari_duzenlenmis/yozgat.json")
...
//# sourceMappingURL=_neighborhood_-DDctUNOP.mjs.map
