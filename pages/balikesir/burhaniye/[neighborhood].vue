...
const { data: balikesirBurhaniyeData } = await useAsyncData("balikesir-burhaniye-data", () =>
  $fetch<any[]>("https://pkodlari.com/data/tr/balikesir/burhaniye.json")
);
...
const otherNeighborhoods = computed(() => {
  ...
  return balikesirBurhaniyeData.value
