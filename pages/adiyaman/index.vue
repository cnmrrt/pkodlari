...
//   adiyamanData.value.forEach((item) => {
...
const pageDesc =
  "Adıyaman iline bağlı ilçe ve mahallelerin posta kodlarını görmek için tıklayın!";
  ...
  <div class="animate-in fade-in duration-500 max-w-4xl mx-auto">
    <div class="mb-10 flex items-center gap-4">
      ...
      <div>
        <h1 class="text-3xl font-bold text-slate-900 tracking-tight">
          Adıyaman Posta Kodları
        </h1>
        <p class="text-slate-500 text-sm font-medium uppercase tracking-wider">9 İLÇE</p>
      </div>
    </div>
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
      <!--[--><a
        ...
        ><div>
          <h3 class="font-bold text-slate-900 text-lg">Besni</h3>
      ...
      ><a
        href="/adiyaman/celikhan"
        class="soft-card p-6 rounded-xl flex items-center justify-between"
        ><div>
          <h3 class="font-bold text-slate-900 text-lg">Çelikhan</h3>
          <p class="text-xs text-slate-400 font-medium uppercase tracking-wider">
            59 mahalle
          </p>
        </div>
        ...
        >
          <path d="m9 18 6-6-6-6"></path></svg></a
      ><a
        href="/adiyaman/gerger"
        class="soft-card p-6 rounded-xl flex items-center justify-between"
        ><div>
          <h3 class="font-bold text-slate-900 text-lg">Gerger</h3>
          <p class="text-xs text-slate-400 font-medium uppercase tracking-wider">
            136 mahalle
          </p>
        </div>
      ...
      ><a
        ...
        class="soft-card p-6 rounded-xl flex items-center justify-between"
        ><div>
          <h3 class="font-bold text-slate-900 text-lg">Kahta</h3>
          <p class="text-xs text-slate-400 font-medium uppercase tracking-wider">
            239 mahalle
          </p>
        </div>
      ...
      ><a
        ...
        >
          <path d="m9 18 6-6-6-6"></path></svg></a
      ><a
        href="/adiyaman/samsat"
        class="soft-card p-6 rounded-xl flex items-center justify-between"
        ><div>
          <h3 class="font-bold text-slate-900 text-lg">Samsat</h3>
          <p class="text-xs text-slate-400 font-medium uppercase tracking-wider">
            40 mahalle
          </p>
        </div>
        ...
        >
          <path d="m9 18 6-6-6-6"></path></svg></a
      ><a
        href="/adiyaman/sincik"
        class="soft-card p-6 rounded-xl flex items-center justify-between"
        ><div>
          <h3 class="font-bold text-slate-900 text-lg">Sincik</h3>
          <p class="text-xs text-slate-400 font-medium uppercase tracking-wider">
            93 mahalle
          </p>
        </div>
      ...
      ><a
        ...
        class="soft-card p-6 rounded-xl flex items-center justify-between"
        ><div>
          <h3 class="font-bold text-slate-900 text-lg">Tut</h3>
          <p class="text-xs text-slate-400 font-medium uppercase tracking-wider">
            27 mahalle
          </p>
        </div>
