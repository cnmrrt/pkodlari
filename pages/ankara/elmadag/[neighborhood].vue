...
const { data: districtData } = await useAsyncData("elmadag-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/ankara/elmadag.json")
);

const cityName = "Ankara";
const citySlug = "ankara";
const districtName = "Elmadağ";
const districtSlug = "elmadag";
