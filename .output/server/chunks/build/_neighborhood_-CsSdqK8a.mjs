...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (isValid.value) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "main-content-neighborhood animate-in fade-in" }, _attrs))}><nav class="flex items-center gap-2 text-xs font-bold text-slateate-400 uppercase tracking-wider mb-8 overflow-x-auto whitespace-nowrap pb-2">`);
...
//# sourceMappingURL=_neighborhood_-CsSdqK8a.mjs.map
