...
const { data: districtData } = await useAsyncData("gungoren-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/istanbul/gungoren.json")
);

const cityName = "İstanbul";
const citySlug = "istanbul";
const districtName = "Güngören";
const districtSlug = "gungoren";
