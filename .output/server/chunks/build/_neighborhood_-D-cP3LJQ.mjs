...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: sivasData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "sivas-data",
      () => $fetch("https://pkodlari.com/data/sivas/all.json")
    ...
    const pageTitle = computed(
      () => neighData.value ? `Sivas ${titleCase(neighData.value.mahalle)} Posta Kodu (${titleCase(
        neighData.value.ilce
      )}/Sivas)` : "Posta Kodu Bulunamad\u0131"
    );
    const pageDesc = computed(
      () => neighData.value ? `Sivas ilinin ${titleCase(neighData.value.ilce)} il\xE7esine ba\u011Fl\u0131 ${titleCase(
        neighData.value.mahalle
      )}'nin posta kodunu g\xF6rmek i\xE7in t\u0131klay\u0131n!` : "Posta Kodu Rehberi"
    );
    useHead({
      title: pageTitle,
              ...
              mainEntity: [
                {
                  ...
                  acceptedAnswer: {
                    "@type": "Answer",
                    text: `${neighData.value.postaKodu} posta kodu Sivas ${titleCase(
                      neighData.value.ilce
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (isValid.value) {
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`Sivas Sayfas\u0131na D\xF6n`);
            } else {
              return [
                createTextVNode("Sivas Sayfas\u0131na D\xF6n")
              ];
            }
          }),
          _: 1
...
//# sourceMappingURL=_neighborhood_-D-cP3LJQ.mjs.map
