...
const { data: districtData } = await useAsyncData("polatli-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/ankara/polatli.json")
);

const cityName = "Ankara";
const citySlug = "ankara";
const districtName = "Polatlı";
const districtSlug = "polatli";
