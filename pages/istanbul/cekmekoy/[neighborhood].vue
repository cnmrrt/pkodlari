...
const { data: districtData } = await useAsyncData("cekmekoy-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/istanbul/cekmekoy.json")
);

const cityName = "İstanbul";
const citySlug = "istanbul";
const districtName = "Çekmeköy";
const districtSlug = "cekmekoy";
