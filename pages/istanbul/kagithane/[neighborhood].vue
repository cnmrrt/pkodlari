...
const { data: districtData } = await useAsyncData("kagithane-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/istanbul/kagithane.json")
);

const cityName = "İstanbul";
const citySlug = "istanbul";
const districtName = "Kağıthane";
const districtSlug = "kagithane";
