...
const { data: districtData } = await useAsyncData("kizilcahamam-details", () =>
  $fetch<any[]>("https://pkodlari.com/data/ankara/kizilcahamam.json")
);

const cityName = "Ankara";
const citySlug = "ankara";
const districtName = "Kızılcahamam";
const districtSlug = "kizilcahamam";
