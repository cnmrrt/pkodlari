...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: kayseriData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "kayseri-data",
      () => $fetch("https://words-from-life-5cb26-default-rtdb.firebaseio.com/posta_kodlari_duzenlenmis/kayseri.json")
...
//# sourceMappingURL=_neighborhood_-B3E13N4y.mjs.map
