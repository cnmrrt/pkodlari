...
const { data: balikesirSındırgıData } = await useAsyncData("balikesir-sindirgi-data", () =>
  $fetch<any[]>(useRequestURL().origin + "/data/balikesir/sindirgi.json")
);
...
const otherNeighborhoods = computed(() => {
  ...
  return balikesirSındırgıData.value
