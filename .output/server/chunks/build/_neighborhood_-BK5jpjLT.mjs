...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: adiyamanData } = ([__temp, __restore] = withAsyncContext(async () => useAsyncData("adiyaman-specific-data", async () => {
      const response = await $fetch("https://words-from-life-5cb26-default-rtdb.firebaseio.com/posta_kodlari_duzenlenmis/adiyaman.json");
      const cityObj = {
        name: "ADIYAMAN",
        districts: {}
      };
    ...
    const districtItem = computed(() => {
      var _a;
      return (_a = adiyamanData.value) == null ? void 0 : _a.districts[distSlug.value];
    });
    ...
    const pageDesc = computed(() => districtItem.value && neighItem.value ? `Ad\u0131yaman ilinin ${titleCase(districtItem.value.name)} il\xE7esine ba\u011Fl\u0131 ${titleCase(neighItem.value.name)}'nin posta kodunu g\xF6rmek i\xE7in t\u0131klay\u0131n!` : "Posta Kodu Rehberi");
    useHead({
      title: pageTitle,
            ...
            children: JSON.stringify({
              ...
              "itemListElement": [
                ...
                },
                {
                  ...
                  "item": `https://postakodu.com/adiyaman/${distSlug.value}`
                },
                {
                  "@type": "ListItem",
                  "position": 4,
                  "name": titleCase(neighItem.value.name),
                  "item": `https://postakodu.com/adiyaman/${distSlug.value}/${neighborhoodSlug.value}`
                }
              ]
            })
          };
...
//# sourceMappingURL=_neighborhood_-BK5jpjLT.mjs.map
