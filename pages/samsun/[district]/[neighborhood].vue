...
<p>{{ neighData.postaKodu }} posta kodu Samsun {{
...
<p>{{ titleCase(neighData.mahalle) }}, Samsun ilinin {{ titleCase(neighData.ilce) }} ilçesine bağlıdır. Posta kodu yapısı incelendiğinde                                                                                              ;</p>
<ol>
