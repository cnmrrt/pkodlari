...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const pageTitle = `Bolu Posta Kodlar\u0131 ve \u0130l\xE7eleri ${currentYear}`;
    useHead({
      title: pageTitle,
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div><h1>Bolu Posta Kodlar\u0131</h1><p>${ssrInterpolate(unref(districts).length)} \u0130L\xC7E</p></div></div><div class="neighborhoods-links-container"><!--[-->`);
...
//# sourceMappingURL=index-C78F9uIf.mjs.map
