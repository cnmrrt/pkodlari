...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: districtData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "altindag-details",
      () => $fetch("https://pkodlari.com/data/ankara/altindag.json")
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/ankara/altindag/[neighborhood].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_neighborhood_-8pbTkxTW.mjs.map
