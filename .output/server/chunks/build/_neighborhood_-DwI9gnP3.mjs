      ...
      meta: [
        {
          ...
          content: computed(() => {
            ...
            return `Mu\u011Fla ilinin ${titleCase(districtItem.value.name)} il\xE7esine ba\u011Fl\u0131 ${titleCase(neighItem.value.name)}'nin posta kodunu g\xF6rmek i\xE7in t\u0131klay\u0131n!`;
          })
        }
      ],
      script: [
...
//# sourceMappingURL=_neighborhood_-DwI9gnP3.mjs.map
