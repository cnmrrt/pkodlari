...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: bilecikData } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      "bilecik-data",
      () => $fetch("https://words-from-life-5cb26-default-rtdb.firebaseio.com/posta_kodlari_duzenlenmis/bilecik.json")
...
//# sourceMappingURL=_neighborhood_-3y1m0X4t.mjs.map
