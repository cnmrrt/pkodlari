...
useHead({
  title: "İstanbul Sarıyer Posta Kodları",
  meta: [
    {
      name: "description",
      content:
        "İstanbul ilinin Sarıyer ilçesine bağlı mahallelerin posta kodlarını görmek için tıklayın!",
    },
  ],
  script: [
    computed(() => {
  ...
  <div class="animate-in fade-in duration-500 max-w-4xl mx-auto">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
      ...
      ><a
        ...
        class="soft-card p-5 flex items-center justify-between group"
        ><div class="min-w-0 pr-4">
          <h4 class="font-semibold text-slate-900 truncate text-base">Maden Mahallesi</h4>
          <p
            class="text-[10px] text-slate-400 font-bold uppercase tracking-widest mt-0.5"
          >
            MAHALLE
      ...
      ><a
        href="/istanbul/sariyer/maslak-mahallesi"
        class="soft-card p-5 flex items-center justify-between group"
        ><div class="min-w-0 pr-4">
          <h4 class="font-semibold text-slate-900 truncate text-base">
            Maslak Mahallesi
      ...
      ><a
        ...
        class="soft-card p-5 flex items-center justify-between group"
        ><div class="min-w-0 pr-4">
          <h4 class="font-semibold text-slate-900 truncate text-base">Pınar Mahallesi</h4>
          <p
            class="text-[10px] text-slate-400 font-bold uppercase tracking-widest mt-0.5"
          >
            MAHALLE
